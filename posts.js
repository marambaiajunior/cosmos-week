...
window.postsData = [
  ...
  },
  {
    ...
    "read_pt": "4 min de leitura",
    "read_en": "4 min read",
    "publishedIso": "2026-04-21T09:17:08.567827+00:00",
    "lastModifiedIso": "2026-04-21T09:38:23+00:00",
    "source": "NIH News Releases",
    "sourceDomain": "www. nih. gov",
    "sourceType": "agency",
  ...
  },
  {
    ...
    "read_pt": "4 min de leitura",
    "read_en": "4 min read",
    "publishedIso": "2026-04-21T09:17:08.567652+00:00",
    "lastModifiedIso": "2026-04-21T09:38:23+00:00",
    "source": "NIH News Releases",
    "sourceDomain": "www. nih. gov",
    "sourceType": "agency",
  ...
  },
  {
    ...
    "video": null,
    "audio": null,
    "title": "O Sistema Solar em Raios X: Desvendando seu Brilho com o eROSITA",
    "title_pt": "O Sistema Solar em Raios X: Desvendando seu Brilho com o eROSITA",
    "title_en": "Behold, the Solar System in All its X-ray Glory",
    "sub": "Utilizando o telescópio espacial eROSITA, pesquisadores do MPE isolaram com êxito o brilho de raios X do nosso Sistema Solar, revelando seu impacto no fundo de raios X de baixa.",
    "sub_pt": "Utilizando o telescópio espacial eROSITA, pesquisadores do MPE isolaram com êxito o brilho de raios X do nosso Sistema Solar, revelando seu impacto no fundo de raios X de baixa.",
    ...
    "excerpt": "Utilizando o telescópio espacial eROSITA, pesquisadores do MPE isolaram com êxito o brilho de raios X do nosso Sistema Solar, revelando seu impacto no fundo de raios X de baixa energia.",
    "excerpt_pt": "Utilizando o telescópio espacial eROSITA, pesquisadores do MPE isolaram com êxito o brilho de raios X do nosso Sistema Solar, revelando seu impacto no fundo de raios X de baixa energia.",
    ...
    "body": "<p>Os quatro mapas celestes produzidos permitiram a extração das emissões de troca de carga do vento solar (SWCX) do fundo cósmico, proporcionando a visão mais clara do brilho suave de raios X do Sistema Solar até o momento. O brilho suave de raios X surge quando íons altamente carregados do vento solar (como carbono e oxigênio) capturam elétrons de átomos neutros na atmosfera superior da Terra (geocorona) e em outras partes da heliosfera.</p><p>A capacidade de distinguir essas emissões foi crucial para a pesquisa. O telescópio SRG/eROSITA possibilitou essa distinção graças à sua localização única em torno do Ponto Lagrange L2. Essa posição estratégica é fundamental, pois evita a interferência de raios X provenientes da geocorona terrestre, que poderia mascarar as emissões mais sutis do Sistema Solar. Sem essa vantagem posicional, a clareza e a precisão dos dados obtidos seriam significativamente comprometidas, dificultando a separação do brilho intrínseco do Sistema Solar do ruído de fundo.</p><p>Os dados coletados pelo eROSITA não apenas permitiram a extração do brilho de raios X do Sistema Solar, mas também abriram novas avenidas para a heliofísica. Pela primeira vez, torna-se possível o estudo detalhado do conteúdo de íons pesados do vento solar, sua variabilidade ao longo do tempo e sua complexa interação com o meio interestelar (ISM). Essa análise aprofundada é vital para compreender melhor a composição e a dinâmica do vento solar, bem como os processos que governam a fronteira entre a heliosfera e o espaço interestelar, fornecendo insights cruciais sobre a física solar e seus efeitos no ambiente espacial.</p><p>Uma análise mais aprofundada dos dados revelou uma região próxima à órbita da Terra com emissões aumentadas de raios X, uma estrutura que não orbita o Sol. Essa descoberta confirmou uma previsão que remonta à década de 1970: a de que a gravidade do Sol cria um &#x27;cone de focalização de hélio&#x27;. Este fenômeno ocorre porque a gravidade solar curva as trajetórias dos átomos de hélio que se movem através do Sistema Solar, concentrando-os em um fluxo mais denso no lado &#x27;a favor do vento&#x27; do Sol. A detecção direta dessa estrutura é um marco significativo para a heliofísica, validando modelos teóricos de longa data sobre a interação do Sol com o meio interestelar local.</p><p>A capacidade do eROSITA de fornecer uma visão tão detalhada do brilho de raios X do Sistema Solar e de fenômenos como o cone de focalização de hélio demonstra o potencial do observatório para revolucionar nossa compreensão do ambiente espacial próximo. As implicações dessas descobertas são vastas, estendendo-se desde a calibração mais precisa de futuros telescópios de raios X até a melhoria dos modelos de previsão do clima espacial. Ao desvendar as complexidades do nosso próprio Sistema Solar em raios X, os pesquisadores estão pavimentando o caminho para uma exploração mais profunda e informada do universo distante.</p>",
    "body_pt": "<p>Os quatro mapas celestes produzidos permitiram a extração das emissões de troca de carga do vento solar (SWCX) do fundo cósmico, proporcionando a visão mais clara do brilho suave de raios X do Sistema Solar até o momento. O brilho suave de raios X surge quando íons altamente carregados do vento solar (como carbono e oxigênio) capturam elétrons de átomos neutros na atmosfera superior da Terra (geocorona) e em outras partes da heliosfera.</p><p>A capacidade de distinguir essas emissões foi crucial para a pesquisa. O telescópio SRG/eROSITA possibilitou essa distinção graças à sua localização única em torno do Ponto Lagrange L2. Essa posição estratégica é fundamental, pois evita a interferência de raios X provenientes da geocorona terrestre, que poderia mascarar as emissões mais sutis do Sistema Solar. Sem essa vantagem posicional, a clareza e a precisão dos dados obtidos seriam significativamente comprometidas, dificultando a separação do brilho intrínseco do Sistema Solar do ruído de fundo.</p><p>Os dados coletados pelo eROSITA não apenas permitiram a extração do brilho de raios X do Sistema Solar, mas também abriram novas avenidas para a heliofísica. Pela primeira vez, torna-se possível o estudo detalhado do conteúdo de íons pesados do vento solar, sua variabilidade ao longo do tempo e sua complexa interação com o meio interestelar (ISM). Essa análise aprofundada é vital para compreender melhor a composição e a dinâmica do vento solar, bem como os processos que governam a fronteira entre a heliosfera e o espaço interestelar, fornecendo insights cruciais sobre a física solar e seus efeitos no ambiente espacial.</p><p>Uma análise mais aprofundada dos dados revelou uma região próxima à órbita da Terra com emissões aumentadas de raios X, uma estrutura que não orbita o Sol. Essa descoberta confirmou uma previsão que remonta à década de 1970: a de que a gravidade do Sol cria um &#x27;cone de focalização de hélio&#x27;. Este fenômeno ocorre porque a gravidade solar curva as trajetórias dos átomos de hélio que se movem através do Sistema Solar, concentrando-os em um fluxo mais denso no lado &#x27;a favor do vento&#x27; do Sol. A detecção direta dessa estrutura é um marco significativo para a heliofísica, validando modelos teóricos de longa data sobre a interação do Sol com o meio interestelar local.</p><p>A capacidade do eROSITA de fornecer uma visão tão detalhada do brilho de raios X do Sistema Solar e de fenômenos como o cone de focalização de hélio demonstra o potencial do observatório para revolucionar nossa compreensão do ambiente espacial próximo. As implicações dessas descobertas são vastas, estendendo-se desde a calibração mais precisa de futuros telescópios de raios X até a melhoria dos modelos de previsão do clima espacial. Ao desvendar as complexidades do nosso próprio Sistema Solar em raios X, os pesquisadores estão pavimentando o caminho para uma exploração mais profunda e informada do universo distante.</p>",
    ...
    "imageAlt": "O Sistema Solar em Raios X: Desvendando seu Brilho com o eROSITA",
    "imageAlt_pt": "O Sistema Solar em Raios X: Desvendando seu Brilho com o eROSITA",
  ...
  },
  {
    ...
    "audio": null,
    "title": "Exoplanetas sem água suficiente não conseguem manter seus ciclos de carbono",
    "title_pt": "Exoplanetas sem água suficiente não conseguem manter seus ciclos de carbono",
    ...
    "excerpt": "A água é essencial para a vida, pois as células dependem de um meio líquido para funcionar. Por essa razão, cientistas dedicam esforços à busca e ao estudo de exoplanetas localizados em zonas habitáveis, investigando como a disponibilidade hídrica influencia.",
    "excerpt_pt": "A água é essencial para a vida, pois as células dependem de um meio líquido para funcionar. Por essa razão, cientistas dedicam esforços à busca e ao estudo de exoplanetas localizados em zonas habitáveis, investigando como a disponibilidade hídrica influencia.",
    ...
    "imageAlt": "Exoplanetas sem água suficiente não conseguem manter seus ciclos de carbono",
    "imageAlt_pt": "Exoplanetas sem água suficiente não conseguem manter seus ciclos de carbono",
  ...
  },
  {
    ...
    "inline_images": [
      {
        ...
        "caption": "NGC 4388, galáxia espiral de perfil",
        "caption_pt": "NGC 4388, galáxia espiral de perfil",
        "caption_en": "NGC 4388, edge-on spiral galaxy"
      },
      {
        ...
        "caption": "Extinção de dentro para fora vs. de fora para dentro, exemplos simulados",
        "caption_pt": "Extinção de dentro para fora vs. de fora para dentro, exemplos simulados",
        "caption_en": "Inside-out vs. outside-in quenching, simulated examples"
      }
    ],
    "video": null,
    "audio": null,
    ...
    "sub": "Simulações de última geração esclarecem como as galáxias morrem e como podemos determinar a causa da morte.",
    "sub_pt": "Simulações de última geração esclarecem como as galáxias morrem e como podemos determinar a causa da morte.",
    "sub_en": "State-of-the-art simulations shed light on how galaxies die, and how we can determine the cause of death.",
    "excerpt": "Simulações de última geração esclarecem como as galáxias morrem e como podemos determinar a causa da morte.",
    "excerpt_pt": "Simulações de última geração esclarecem como as galáxias morrem e como podemos determinar a causa da morte.",
    ...
    "body": "<p>Novas simulações de última geração estão fornecendo clareza sobre os mecanismos pelos quais as galáxias cessam sua formação estelar, um processo frequentemente referido como &#x27;morte&#x27; galáctica, e como é possível identificar as causas subjacentes a esse fenômeno. Uma equipe de pesquisadores, utilizando a simulação cosmológica avançada conhecida como Illustris TNG50, conseguiu identificar, pela primeira vez, centenas de grandes galáxias que se encontram em um estado de &#x27;morte&#x27; ou extinção.</p><p>Para realizar essa identificação, Lawler-Forsyth e seus colaboradores empregaram uma metodologia inovadora: cada galáxia foi segmentada em uma série de círculos concêntricos. Em seguida, a quantidade de formação estelar foi meticulosamente medida em cada uma dessas seções. Conforme Lawler-Forsyth explicou, &quot;Existem muitas formas de quantificar a formação estelar, mas esses parâmetros pareciam uma maneira sensata de capturar os padrões que observávamos&quot;. Essa abordagem permitiu uma análise detalhada da distribuição da atividade de formação estelar dentro das galáxias.</p><p>O estudo abrangeu um total de 1.666 galáxias dentro da simulação, das quais 361 foram classificadas como &#x27;extintas&#x27;, ou seja, haviam cessado a formação de estrelas até o final do período simulado. Dentre essas galáxias extintas, 78 apresentaram um padrão de cessação da formação estelar que começou nas regiões centrais e progrediu para as áreas mais externas. Em contraste, outras 185 galáxias exibiram o padrão oposto, com a supressão da formação estelar iniciando-se nas regiões periféricas antes de avançar para o centro galáctico.</p><p>Essa metodologia foi bem recebida pela comunidade científica. Kevin Bundy, da Universidade da Califórnia, Santa Cruz, que liderou o Mapeamento de Galáxias Próximas no Observatório Apache Point (MANGA), um vasto estudo de galáxias, comentou: &quot;Essa é uma boa abordagem&quot;. O projeto MANGA, por sua vez, tem como objetivo mapear a formação estelar em quase 10.000 galáxias próximas, buscando compreender sua evolução desde o nascimento até a extinção. A comparação entre os resultados da simulação Illustris TNG50 e observações como as do MANGA é crucial para validar e refinar os modelos teóricos.</p><p>A pesquisa de Bundy e sua equipe, em grande parte, observa um processo de extinção que se manifesta de dentro para fora. No entanto, ele ressalta que a extinção de fora para dentro pode ser favorecida em ambientes específicos, como aglomerados de galáxias, que são caracterizados por sua densidade. Essa distinção sugere que o ambiente galáctico desempenha um papel significativo na determinação do modo como uma galáxia cessa sua formação estelar, com diferentes cenários favorecendo diferentes padrões de &#x27;morte&#x27;.</p><p>Os resultados da simulação Illustris TNG50, ao detalhar os padrões de extinção galáctica, oferecem uma nova perspectiva sobre a complexidade da evolução das galáxias. A capacidade de distinguir entre a cessação da formação estelar que começa no centro e aquela que se inicia nas periferias é fundamental para desvendar os mecanismos físicos que impulsionam esses processos. Compreender se uma galáxia &#x27;morre&#x27; de dentro para fora ou de fora para dentro pode fornecer pistas cruciais sobre os fatores que a levaram a esse estado, sejam eles internos, como o esgotamento de gás, ou externos, como interações com outras galáxias ou o ambiente de um aglomerado.</p><p>Em última análise, este estudo reforça a ideia de que a &#x27;morte&#x27; galáctica não é um evento uniforme ou instantâneo, mas sim um processo multifacetado que se desenrola de maneiras distintas, dependendo de uma série de variáveis astrofísicas. A capacidade de simulações de alta resolução de replicar e prever esses padrões é um avanço significativo para a cosmologia, permitindo que os cientistas testem hipóteses e aprofundem nossa compreensão sobre o ciclo de vida das galáxias no universo.</p>",
    "body_pt": "<p>Novas simulações de última geração estão fornecendo clareza sobre os mecanismos pelos quais as galáxias cessam sua formação estelar, um processo frequentemente referido como &#x27;morte&#x27; galáctica, e como é possível identificar as causas subjacentes a esse fenômeno. Uma equipe de pesquisadores, utilizando a simulação cosmológica avançada conhecida como Illustris TNG50, conseguiu identificar, pela primeira vez, centenas de grandes galáxias que se encontram em um estado de &#x27;morte&#x27; ou extinção.</p><p>Para realizar essa identificação, Lawler-Forsyth e seus colaboradores empregaram uma metodologia inovadora: cada galáxia foi segmentada em uma série de círculos concêntricos. Em seguida, a quantidade de formação estelar foi meticulosamente medida em cada uma dessas seções. Conforme Lawler-Forsyth explicou, &quot;Existem muitas formas de quantificar a formação estelar, mas esses parâmetros pareciam uma maneira sensata de capturar os padrões que observávamos&quot;. Essa abordagem permitiu uma análise detalhada da distribuição da atividade de formação estelar dentro das galáxias.</p><p>O estudo abrangeu um total de 1.666 galáxias dentro da simulação, das quais 361 foram classificadas como &#x27;extintas&#x27;, ou seja, haviam cessado a formação de estrelas até o final do período simulado. Dentre essas galáxias extintas, 78 apresentaram um padrão de cessação da formação estelar que começou nas regiões centrais e progrediu para as áreas mais externas. Em contraste, outras 185 galáxias exibiram o padrão oposto, com a supressão da formação estelar iniciando-se nas regiões periféricas antes de avançar para o centro galáctico.</p><p>Essa metodologia foi bem recebida pela comunidade científica. Kevin Bundy, da Universidade da Califórnia, Santa Cruz, que liderou o Mapeamento de Galáxias Próximas no Observatório Apache Point (MANGA), um vasto estudo de galáxias, comentou: &quot;Essa é uma boa abordagem&quot;. O projeto MANGA, por sua vez, tem como objetivo mapear a formação estelar em quase 10.000 galáxias próximas, buscando compreender sua evolução desde o nascimento até a extinção. A comparação entre os resultados da simulação Illustris TNG50 e observações como as do MANGA é crucial para validar e refinar os modelos teóricos.</p><p>A pesquisa de Bundy e sua equipe, em grande parte, observa um processo de extinção que se manifesta de dentro para fora. No entanto, ele ressalta que a extinção de fora para dentro pode ser favorecida em ambientes específicos, como aglomerados de galáxias, que são caracterizados por sua densidade. Essa distinção sugere que o ambiente galáctico desempenha um papel significativo na determinação do modo como uma galáxia cessa sua formação estelar, com diferentes cenários favorecendo diferentes padrões de &#x27;morte&#x27;.</p><p>Os resultados da simulação Illustris TNG50, ao detalhar os padrões de extinção galáctica, oferecem uma nova perspectiva sobre a complexidade da evolução das galáxias. A capacidade de distinguir entre a cessação da formação estelar que começa no centro e aquela que se inicia nas periferias é fundamental para desvendar os mecanismos físicos que impulsionam esses processos. Compreender se uma galáxia &#x27;morre&#x27; de dentro para fora ou de fora para dentro pode fornecer pistas cruciais sobre os fatores que a levaram a esse estado, sejam eles internos, como o esgotamento de gás, ou externos, como interações com outras galáxias ou o ambiente de um aglomerado.</p><p>Em última análise, este estudo reforça a ideia de que a &#x27;morte&#x27; galáctica não é um evento uniforme ou instantâneo, mas sim um processo multifacetado que se desenrola de maneiras distintas, dependendo de uma série de variáveis astrofísicas. A capacidade de simulações de alta resolução de replicar e prever esses padrões é um avanço significativo para a cosmologia, permitindo que os cientistas testem hipóteses e aprofundem nossa compreensão sobre o ciclo de vida das galáxias no universo.</p>",
    "body_en": "<p>State-of-the-art simulations shed light on how galaxies die, and how we can determine the cause of death. The post Galaxies Don’t Die All at Once appeared first on Sky &amp; Telescope. The institutional report frames the development in practical terms and ties it to the broader mission or observing effort.</p><p>This matters because astronomy does not advance on single detections. The field builds confidence by accumulating independent observations across different wavelengths, instruments and epochs until isolated signals become defensible conclusions. What looks convincing in one dataset can dissolve when a second instrument looks at the same target, and what looks marginal can solidify when follow-up campaigns confirm the original reading. The current standard requires that a result survive this triangulation before the community treats it as settled. Using a zoomed-in cosmological simulation known as Illustris TNG50, the team first identified hundreds of large, dying galaxies. To do that, Lawler-Forsyth and colleagues divided each galaxy into a series of concentric circles, then measured the amount of star formation in each section.</p><p>There are many ways to quantify star formation,” Lawler-Forsyth says, “but these parameters seemed like a sensible way to capture the patterns we were seeing. Of these, 78 ceased star formation first near the center, then in the outer regions.</p><p>Another 185 galaxies quenched the opposite way, with star formation first suppressed in the outskirts. This is a good approach,” says Kevin Bundy (University of California, Santa Cruz), who led a large galaxy survey known as Mapping Nearby Galaxies at Apache Point Observatory.</p><p>This survey maps the star formation in nearly 10, 000 nearby galaxies with a goal to understand how they evolve from birth to death. For the most part, we see inside-out quenching, but that may be because outside-in is favored in rare, dense environments like galaxy clusters.</p><p>What gives the story weight is not just the object itself, but the way the measurement trims the range of plausible physical explanations. Astronomy has accumulated enough cases to know that the most interesting results are rarely the ones that confirm expectations cleanly; they are the ones that confirm some expectations while complicating others, or that open a parameter space that previous instruments could not reach. The scientific community evaluates these contributions by asking whether the new data constrain a model in a way that older data could not, and whether those constraints survive systematic review.</p><p>If a galaxy ceases forming stars near the center first, it’s likely because there’s a heat source there: the central supermassive black hole that lurks in most large galaxies. If you can heat it up, pull it out, or stop more gas from falling in, you shut down star formation.</p><p>Because the account originates with Sky &amp; Telescope, it functions best as a primary institutional report that is close to the data and operations, not as independent scientific validation. Institutional communications are produced by organizations with legitimate interests in presenting their work in a favorable light, which does not make them unreliable but does make them partial. Details that complicate the narrative, including instrument limitations, unexpected failures and results below projections, tend to be minimized relative to progress messages. Technical documentation and peer-reviewed publications, where they exist, provide the complementary layer that institutional releases cannot substitute.</p><p>The next step is to see whether other instruments and other wavelengths tell the same story. Campaigns with JWST, the VLT, the forthcoming Extremely Large Telescopes and radio arrays will provide the spectral coverage and spatial resolution needed to move from detection to physical characterization. The timeline for that kind of confirmation is typically measured in years, not months, which is worth keeping in mind when reading the current result.</p><p class=\"art-source\"><a href=\"https://skyandtelescope.org/astronomy-news/galaxies-dont-die-all-at-once/\" target=\"_blank\" rel=\"noopener noreferrer\">Source</a></p>",
    "highlights": [
    ...
    "highlights_en": [
      "Focus: State-of-the-art simulations shed light on how galaxies die, and how we can determine the cause of death",
      "Detail: Institutional origin: separate announcement from evidence",
      "Editorial reading: science reporting; whenever possible, verify the cited primary source."
    ],
    "date": "20 abr 2026",
    ...
    "realUrl": "https://www.cosmosweek.com/?article=galaxies-don-t-die-all-at-once",
    "realUrl_pt": "https://www.cosmosweek.com/?article=galaxies-don-t-die-all-at-once",
    "realUrl_en": "https://www.cosmosweek.com/?article=galaxies-don-t-die-all-at-once&lang=en",
    "shareUrl": "https://www.cosmosweek.com/noticia/galaxies-don-t-die-all-at-once/",
    "shareUrl_pt": "https://www.cosmosweek.com/noticia/galaxies-don-t-die-all-at-once/",
    "shareUrl_en": "https://www.cosmosweek.com/en/news/galaxies-don-t-die-all-at-once/",
    "canonicalUrl": "https://www.cosmosweek.com/noticia/galaxies-don-t-die-all-at-once/",
    "canonicalUrl_pt": "https://www.cosmosweek.com/noticia/galaxies-don-t-die-all-at-once/",
    "canonicalUrl_en": "https://www.cosmosweek.com/en/news/galaxies-don-t-die-all-at-once/",
    "defaultLanguage": "pt-BR",
    "availableLanguages": [
      "pt-BR",
      "en-US"
    ...
    "imageAlt": "Galáxias não morrem de uma só vez",
    "imageAlt_pt": "Galáxias não morrem de uma só vez",
    "imageAlt_en": "Galaxies Don’t Die All at Once",
    "coverageKind": "news",
    "coverageKindLabel": "Jornalismo científico",
    "coverageKindLabel_pt": "Jornalismo científico",
    "coverageKindLabel_en": "Science journalism",
  ...
  },
  {
    ...
    "sub": "Um novo estudo confirma que as leis da gravidade de Newton e Einstein se aplicam consistentemente nas maiores estruturas do universo, fortalecendo a hipótese da matéria escura.",
    "sub_pt": "Um novo estudo confirma que as leis da gravidade de Newton e Einstein se aplicam consistentemente nas maiores estruturas do universo, fortalecendo a hipótese da matéria escura.",
    "sub_en": "Newton and Einstein's laws of gravity hold true across the largest structures in the universe.",
    "excerpt": "Um novo estudo confirma que as leis da gravidade de Newton e Einstein se aplicam consistentemente nas maiores estruturas do universo, fortalecendo a hipótese da matéria escura.",
    "excerpt_pt": "Um novo estudo confirma que as leis da gravidade de Newton e Einstein se aplicam consistentemente nas maiores estruturas do universo, fortalecendo a hipótese da matéria escura.",
    ...
    "body": "<p>Um recente estudo revelou que as leis da gravidade, formuladas por Isaac Newton e Albert Einstein, são aplicáveis de forma consistente em todo o universo, inclusive em suas maiores estruturas. Esta nova evidência, obtida através de medições em escalas cósmicas que abrangem centenas de milhões de anos-luz, sugere que a gravidade se comporta da mesma maneira tanto em nosso ambiente próximo quanto em vastas distâncias intergalácticas. Tal constatação reforça significativamente a hipótese da existência de matéria escura invisível em grandes quantidades no espaço, um dos maiores mistérios da cosmologia moderna.</p><p>A gravidade, conforme descrita por Isaac Newton no século XVII, é a força fundamental que governa a atração entre corpos, como a que puxa uma maçã em queda em direção à Terra. Posteriormente, Albert Einstein, no início do século XX, expandiu essa compreensão com sua teoria da relatividade geral, que descreve a gravidade como uma curvatura do espaço-tempo. Cientistas contemporâneos frequentemente investigam se essas leis, desenvolvidas em diferentes épocas, mantêm sua validade universal. O estudo em questão buscou precisamente verificar a aplicabilidade dessas teorias em escalas cósmicas, testando sua consistência em ambientes onde as condições são drasticamente diferentes das observadas em nosso sistema solar.</p><p>As descobertas da pesquisa, publicadas na revista Physical Review Letters em 15 de abril de 2026, indicam que a força da gravidade realmente enfraquece com a distância, um comportamento que está em quase exata conformidade com as previsões das equações de Newton e, subsequentemente, incorporadas na teoria da relatividade geral de Einstein. Este resultado é crucial, pois valida a robustez dessas teorias em um contexto que vai muito além das observações iniciais que as fundamentaram. A precisão com que os dados observacionais se alinham com os modelos teóricos existentes é um testemunho da profundidade e da abrangência do nosso entendimento atual sobre a gravidade.</p><p>Conforme destacado por Gallardo, um dos pesquisadores envolvidos, &quot;É notável que a lei do inverso dos quadrados, proposta por Newton no século XVII e depois incorporada pela teoria da relatividade geral de Einstein, ainda se mantenha firme no século XXI. &quot; Essa afirmação sublinha a duradoura relevância e a precisão dessas formulações clássicas e modernas da gravidade. A persistência dessas leis em escalas tão vastas e em um período tão longo de tempo é um feito notável da ciência, demonstrando a capacidade humana de desvendar os princípios fundamentais que regem o universo.</p><p>A confirmação da validade das leis gravitacionais em escalas cósmicas tem implicações profundas para a cosmologia. Se a gravidade se comporta como esperado, então a discrepância entre a massa observada e a massa gravitacionalmente inferida em galáxias e aglomerados de galáxias não pode ser atribuída a uma falha nas leis da gravidade. Em vez disso, essa discrepância aponta fortemente para a existência de uma forma de matéria invisível – a matéria escura – que interage gravitacionalmente, mas não emite nem absorve luz. Este estudo, portanto, não apenas valida teorias existentes, mas também fortalece a base para futuras investigações sobre a natureza e a distribuição da matéria escura no cosmos.</p>",
    "body_pt": "<p>Um recente estudo revelou que as leis da gravidade, formuladas por Isaac Newton e Albert Einstein, são aplicáveis de forma consistente em todo o universo, inclusive em suas maiores estruturas. Esta nova evidência, obtida através de medições em escalas cósmicas que abrangem centenas de milhões de anos-luz, sugere que a gravidade se comporta da mesma maneira tanto em nosso ambiente próximo quanto em vastas distâncias intergalácticas. Tal constatação reforça significativamente a hipótese da existência de matéria escura invisível em grandes quantidades no espaço, um dos maiores mistérios da cosmologia moderna.</p><p>A gravidade, conforme descrita por Isaac Newton no século XVII, é a força fundamental que governa a atração entre corpos, como a que puxa uma maçã em queda em direção à Terra. Posteriormente, Albert Einstein, no início do século XX, expandiu essa compreensão com sua teoria da relatividade geral, que descreve a gravidade como uma curvatura do espaço-tempo. Cientistas contemporâneos frequentemente investigam se essas leis, desenvolvidas em diferentes épocas, mantêm sua validade universal. O estudo em questão buscou precisamente verificar a aplicabilidade dessas teorias em escalas cósmicas, testando sua consistência em ambientes onde as condições são drasticamente diferentes das observadas em nosso sistema solar.</p><p>As descobertas da pesquisa, publicadas na revista Physical Review Letters em 15 de abril de 2026, indicam que a força da gravidade realmente enfraquece com a distância, um comportamento que está em quase exata conformidade com as previsões das equações de Newton e, subsequentemente, incorporadas na teoria da relatividade geral de Einstein. Este resultado é crucial, pois valida a robustez dessas teorias em um contexto que vai muito além das observações iniciais que as fundamentaram. A precisão com que os dados observacionais se alinham com os modelos teóricos existentes é um testemunho da profundidade e da abrangência do nosso entendimento atual sobre a gravidade.</p><p>Conforme destacado por Gallardo, um dos pesquisadores envolvidos, &quot;É notável que a lei do inverso dos quadrados, proposta por Newton no século XVII e depois incorporada pela teoria da relatividade geral de Einstein, ainda se mantenha firme no século XXI. &quot; Essa afirmação sublinha a duradoura relevância e a precisão dessas formulações clássicas e modernas da gravidade. A persistência dessas leis em escalas tão vastas e em um período tão longo de tempo é um feito notável da ciência, demonstrando a capacidade humana de desvendar os princípios fundamentais que regem o universo.</p><p>A confirmação da validade das leis gravitacionais em escalas cósmicas tem implicações profundas para a cosmologia. Se a gravidade se comporta como esperado, então a discrepância entre a massa observada e a massa gravitacionalmente inferida em galáxias e aglomerados de galáxias não pode ser atribuída a uma falha nas leis da gravidade. Em vez disso, essa discrepância aponta fortemente para a existência de uma forma de matéria invisível – a matéria escura – que interage gravitacionalmente, mas não emite nem absorve luz. Este estudo, portanto, não apenas valida teorias existentes, mas também fortalece a base para futuras investigações sobre a natureza e a distribuição da matéria escura no cosmos.</p>",
    ...
    "highlights": [
      "Em foco: Um novo estudo confirma que as leis da gravidade de Newton e Einstein se aplicam consistentemente nas maiores estruturas do universo, fortalecendo a",
      "Detalhe: Origem institucional: distinguir anúncio de evidência",
      "Leitura editorial: reportagem científica; quando possível, confira a fonte primária citada."
    ],
    "highlights_pt": [
  ...
  },
  {
    ...
    "video": null,
    "audio": null,
    "title": "A Propagação de Cinzas Escuras em Marte: Uma Análise do Mars Express",
    "title_pt": "A Propagação de Cinzas Escuras em Marte: Uma Análise do Mars Express",
    "title_en": "Ash creeps across Mars",
    "sub": "Enquanto as mudanças geológicas em Marte geralmente ocorrem ao longo de milhões de anos, o Mars Express da Agência Espacial Europeia registrou a rápida propagação de um manto de.",
    "sub_pt": "Enquanto as mudanças geológicas em Marte geralmente ocorrem ao longo de milhões de anos, o Mars Express da Agência Espacial Europeia registrou a rápida propagação de um manto de.",
    ...
    "excerpt": "Enquanto as mudanças geológicas em Marte geralmente ocorrem ao longo de milhões de anos, o Mars Express da Agência Espacial Europeia registrou a rápida propagação de um manto de cinzas escuras por todo o planeta em apenas algumas décadas.",
    "excerpt_pt": "Enquanto as mudanças geológicas em Marte geralmente ocorrem ao longo de milhões de anos, o Mars Express da Agência Espacial Europeia registrou a rápida propagação de um manto de cinzas escuras por todo o planeta em apenas algumas décadas.",
    ...
    "body": "<p>Ao contrário da poeira de tonalidade ocre e das rochas fragmentadas que predominam na superfície marciana, acredita-se que este material escuro seja de origem vulcânica, produzido e distribuído por atividades geológicas. Marte, de fato, é o lar do maior vulcão do Sistema Solar, o Olympus Mons, cuja altura supera em mais de duas vezes a do Mauna Kea, o maior vulcão terrestre. A presença de tais estruturas vulcânicas reforça a hipótese de que as cinzas observadas são um produto direto da atividade geológica interna do planeta, mesmo que em escalas de tempo mais recentes.</p><p>A rápida propagação dessas cinzas ao longo das últimas cinco décadas levanta duas hipóteses principais para sua ocorrência. A primeira sugere que as cinzas foram ativamente recolhidas e transportadas pelos ventos marcianos, que são conhecidos por sua capacidade de mover grandes volumes de material pela superfície do planeta. A segunda explicação postula que a poeira ocre, que anteriormente cobria os depósitos de cinzas escuras, foi removida pela ação eólica, expondo e revelando o material subjacente. Ambas as possibilidades indicam a influência significativa dos processos atmosféricos na dinâmica da superfície marciana.</p><p>A região em questão, onde as cinzas foram observadas, está situada em Utopia Planitia, uma das bacias de impacto mais colossais de Marte. Esta antiga bacia possui um diâmetro impressionante de aproximadamente 3300 km, o que equivale a pouco menos do dobro da extensão norte-sul do deserto do Saara na Terra. Dentro dessa vasta planície, uma cratera de cerca de 15 km de diâmetro se destaca, exibindo linhas onduladas intrigantes em seu interior. Essas formações sugerem o movimento de material gelado que se arrastou pela cratera em algum momento de sua história geológica, evidenciando a complexidade dos processos superficiais marcianos.</p><p>As formações de cinzas e outras características geológicas em Utopia Planitia não se manifestam de forma isolada; elas frequentemente se fundem, criando áreas de maior extensão e oferecendo um testemunho claro da constante evolução da superfície marciana. Adicionalmente, na porção mais à esquerda da imagem, é possível identificar uma característica peculiar e recorrente em Utopia Planitia: uma série de fossos escuros. Com aproximadamente 20 km de comprimento e 2 km de largura, esses fossos se estendem pela superfície, convergindo para formar uma estrutura de grandes dimensões. Tais elementos sublinham a natureza dinâmica e multifacetada dos processos geológicos e atmosféricos que moldam o planeta vermelho.</p>",
    "body_pt": "<p>Ao contrário da poeira de tonalidade ocre e das rochas fragmentadas que predominam na superfície marciana, acredita-se que este material escuro seja de origem vulcânica, produzido e distribuído por atividades geológicas. Marte, de fato, é o lar do maior vulcão do Sistema Solar, o Olympus Mons, cuja altura supera em mais de duas vezes a do Mauna Kea, o maior vulcão terrestre. A presença de tais estruturas vulcânicas reforça a hipótese de que as cinzas observadas são um produto direto da atividade geológica interna do planeta, mesmo que em escalas de tempo mais recentes.</p><p>A rápida propagação dessas cinzas ao longo das últimas cinco décadas levanta duas hipóteses principais para sua ocorrência. A primeira sugere que as cinzas foram ativamente recolhidas e transportadas pelos ventos marcianos, que são conhecidos por sua capacidade de mover grandes volumes de material pela superfície do planeta. A segunda explicação postula que a poeira ocre, que anteriormente cobria os depósitos de cinzas escuras, foi removida pela ação eólica, expondo e revelando o material subjacente. Ambas as possibilidades indicam a influência significativa dos processos atmosféricos na dinâmica da superfície marciana.</p><p>A região em questão, onde as cinzas foram observadas, está situada em Utopia Planitia, uma das bacias de impacto mais colossais de Marte. Esta antiga bacia possui um diâmetro impressionante de aproximadamente 3300 km, o que equivale a pouco menos do dobro da extensão norte-sul do deserto do Saara na Terra. Dentro dessa vasta planície, uma cratera de cerca de 15 km de diâmetro se destaca, exibindo linhas onduladas intrigantes em seu interior. Essas formações sugerem o movimento de material gelado que se arrastou pela cratera em algum momento de sua história geológica, evidenciando a complexidade dos processos superficiais marcianos.</p><p>As formações de cinzas e outras características geológicas em Utopia Planitia não se manifestam de forma isolada; elas frequentemente se fundem, criando áreas de maior extensão e oferecendo um testemunho claro da constante evolução da superfície marciana. Adicionalmente, na porção mais à esquerda da imagem, é possível identificar uma característica peculiar e recorrente em Utopia Planitia: uma série de fossos escuros. Com aproximadamente 20 km de comprimento e 2 km de largura, esses fossos se estendem pela superfície, convergindo para formar uma estrutura de grandes dimensões. Tais elementos sublinham a natureza dinâmica e multifacetada dos processos geológicos e atmosféricos que moldam o planeta vermelho.</p>",
    ...
    "highlights": [
      "Em foco: Enquanto as mudanças geológicas em Marte geralmente ocorrem ao longo de milhões de anos, o Mars Express da Agência Espacial Europeia registrou a",
      "Detalhe: Origem institucional: distinguir anúncio de evidência",
      "Leitura editorial: release institucional, útil como fonte primária, mas não como validação independente."
    ],
    "highlights_pt": [
    ...
    "imageAlt": "A Propagação de Cinzas Escuras em Marte: Uma Análise do Mars Express",
    "imageAlt_pt": "A Propagação de Cinzas Escuras em Marte: Uma Análise do Mars Express",
  ...
  },
  {
    ...
    "video": null,
    "audio": null,
    "title": "Primeira Luz para o PoET: A Importância da Luz Solar na Pesquisa de Exoplanetas",
    "title_pt": "Primeira Luz para o PoET: A Importância da Luz Solar na Pesquisa de Exoplanetas",
    ...
    "body": "<p>O Telescópio Solar ESPRESSO do Paranal (PoET), instalado no Observatório Europeu do Sul (ESO), no Chile, realizou suas primeiras observações. Este novo telescópio funcionará em conjunto com o instrumento ESPRESSO do ESO, com o objetivo de estudar o Sol em detalhes. As observações do PoET são consideradas fundamentais para a descoberta e caracterização de exoplanetas, especialmente aqueles que podem estar atualmente ocultos pelo ruído estelar.</p><p>A atividade superficial em estrelas, similar às manchas solares que alteram a luz do nosso Sol, distorce o espectro estelar de uma forma que pode ser medida como &#x27;ruído&#x27; pela instrumentação atual de busca por exoplanetas. Esse fenômeno representa um obstáculo significativo, pois a presença desse ruído pode mascarar os sinais sutis de planetas orbitando outras estrelas. Remover esse ruído dos espectros de estrelas distantes, contudo, é um desafio complexo, uma vez que ainda não compreendemos completamente como a atividade estelar altera a luz que observamos.</p><p>O projeto inovador do PoET permite que ele utilize o Sol como um laboratório natural para compreender os espectros de estrelas distantes. Equipado com um telescópio que possui um espelho de 60 centímetros de diâmetro, o PoET é capaz de captar luz de áreas específicas do Sol, como manchas solares individuais. Ao investigar as assinaturas da atividade estelar em nosso próprio Sol com uma precisão sem precedentes, os cientistas esperam desenvolver métodos mais eficazes para distinguir os sinais planetários do ruído estelar em observações de exoplanetas.</p><p>O ESPRESSO, um instrumento exoplanetário de alta precisão montado no Very Large Telescope (VLT) do ESO, é tradicionalmente utilizado para observar estrelas distantes durante a noite. Com a integração do PoET, o ESPRESSO agora também será empregado durante o dia para analisar espectros solares. Essa abordagem inovadora maximiza a utilização do instrumento. &quot;Ao alternar do VLT à noite para o PoET durante o dia, maximizamos a utilização deste instrumento para nos auxiliar na descoberta e caracterização de exoplanetas&quot;, afirma Alain Smette, astrônomo do pessoal de operações do VLT e contato do ESO para o PoET.</p><p>O desenvolvimento do PoET é fruto de um esforço colaborativo, tendo sido concebido e desenvolvido em Portugal. O projeto recebeu financiamento crucial do Conselho Europeu de Investigação, destacando a importância da pesquisa europeia na astronomia. Uma equipe dedicada de 12 pesquisadores portugueses desempenhou um papel fundamental, estando presente na instalação e nos testes iniciais do telescópio solar, garantindo sua operacionalidade e a qualidade dos dados coletados.</p>",
    "body_pt": "<p>O Telescópio Solar ESPRESSO do Paranal (PoET), instalado no Observatório Europeu do Sul (ESO), no Chile, realizou suas primeiras observações. Este novo telescópio funcionará em conjunto com o instrumento ESPRESSO do ESO, com o objetivo de estudar o Sol em detalhes. As observações do PoET são consideradas fundamentais para a descoberta e caracterização de exoplanetas, especialmente aqueles que podem estar atualmente ocultos pelo ruído estelar.</p><p>A atividade superficial em estrelas, similar às manchas solares que alteram a luz do nosso Sol, distorce o espectro estelar de uma forma que pode ser medida como &#x27;ruído&#x27; pela instrumentação atual de busca por exoplanetas. Esse fenômeno representa um obstáculo significativo, pois a presença desse ruído pode mascarar os sinais sutis de planetas orbitando outras estrelas. Remover esse ruído dos espectros de estrelas distantes, contudo, é um desafio complexo, uma vez que ainda não compreendemos completamente como a atividade estelar altera a luz que observamos.</p><p>O projeto inovador do PoET permite que ele utilize o Sol como um laboratório natural para compreender os espectros de estrelas distantes. Equipado com um telescópio que possui um espelho de 60 centímetros de diâmetro, o PoET é capaz de captar luz de áreas específicas do Sol, como manchas solares individuais. Ao investigar as assinaturas da atividade estelar em nosso próprio Sol com uma precisão sem precedentes, os cientistas esperam desenvolver métodos mais eficazes para distinguir os sinais planetários do ruído estelar em observações de exoplanetas.</p><p>O ESPRESSO, um instrumento exoplanetário de alta precisão montado no Very Large Telescope (VLT) do ESO, é tradicionalmente utilizado para observar estrelas distantes durante a noite. Com a integração do PoET, o ESPRESSO agora também será empregado durante o dia para analisar espectros solares. Essa abordagem inovadora maximiza a utilização do instrumento. &quot;Ao alternar do VLT à noite para o PoET durante o dia, maximizamos a utilização deste instrumento para nos auxiliar na descoberta e caracterização de exoplanetas&quot;, afirma Alain Smette, astrônomo do pessoal de operações do VLT e contato do ESO para o PoET.</p><p>O desenvolvimento do PoET é fruto de um esforço colaborativo, tendo sido concebido e desenvolvido em Portugal. O projeto recebeu financiamento crucial do Conselho Europeu de Investigação, destacando a importância da pesquisa europeia na astronomia. Uma equipe dedicada de 12 pesquisadores portugueses desempenhou um papel fundamental, estando presente na instalação e nos testes iniciais do telescópio solar, garantindo sua operacionalidade e a qualidade dos dados coletados.</p>",
    ...
    "imageAlt": "Primeira Luz para o PoET: A Importância da Luz Solar na Pesquisa de Exoplanetas",
    "imageAlt_pt": "Primeira Luz para o PoET: A Importância da Luz Solar na Pesquisa de Exoplanetas",
  ...
  },
  {
    ...
    "video": null,
    "audio": null,
    "title": "Artemis II: Missão Tripulada Retorna à Órbita Lunar Após Mais de Meio Século",
    "title_pt": "Artemis II: Missão Tripulada Retorna à Órbita Lunar Após Mais de Meio Século",
    "title_en": "Artemis II blasts off, sending humans back to the Moon",
    "sub": "A missão Artemis II da NASA enviou astronautas em uma jornada ao redor da Lua, marcando o primeiro voo tripulado lunar em mais de 50 anos e preparando o caminho para futuras.",
    "sub_pt": "A missão Artemis II da NASA enviou astronautas em uma jornada ao redor da Lua, marcando o primeiro voo tripulado lunar em mais de 50 anos e preparando o caminho para futuras.",
    "sub_en": "NASA's Artemis II mission has just launched people to the Moon for the first time in over 50 years.",
    "excerpt": "A missão Artemis II da NASA enviou astronautas em uma jornada ao redor da Lua, marcando o primeiro voo tripulado lunar em mais de 50 anos e preparando o caminho para futuras explorações e pousos.",
    "excerpt_pt": "A missão Artemis II da NASA enviou astronautas em uma jornada ao redor da Lua, marcando o primeiro voo tripulado lunar em mais de 50 anos e preparando o caminho para futuras explorações e pousos.",
    "excerpt_en": "NASA's Artemis II mission has just launched people to the Moon for the first time in over 50 years.",
    "body": "<p>A missão Artemis II da NASA marcou um momento histórico na exploração espacial, enviando quatro astronautas em uma jornada de 10 dias ao redor da Lua. Este voo representa a primeira vez que seres humanos viajam em direção à órbita lunar em mais de meio século, desde a missão Apollo 17. Em 1º de abril, no horário de verão do leste (EDT), a missão Artemis II decolou do Centro Espacial Kennedy, em Cabo Canaveral, Flórida, com o objetivo principal de testar os sistemas da espaçonave Orion e os procedimentos de voo tripulado antes de futuras missões que incluirão o pouso de astronautas na superfície lunar. O sucesso deste lançamento é um testemunho da engenhosidade humana e da colaboração internacional, reafirmando o compromisso da humanidade com a exploração do espaço profundo.</p><p>A bordo da espaçonave Orion, a tripulação é composta por nomes que já fazem história. Christina Koch se tornou a primeira mulher a viajar em uma missão lunar, enquanto Victor Glover é o primeiro afro-americano a participar de um voo com destino à Lua. Jeremy Hansen, por sua vez, é o primeiro canadense a integrar uma missão lunar. A diversidade e a experiência desses astronautas sublinham a natureza global e inclusiva da nova era de exploração lunar, inspirando gerações futuras a olhar para as estrelas.</p><p>Durante os dez dias de missão, os astronautas realizarão uma série de testes críticos para avaliar o desempenho da Orion e a capacidade da tripulação de operar em um ambiente de espaço profundo. A espaçonave, que tem o tamanho aproximado de uma van de mudança, servirá como lar e laboratório para os quatro tripulantes. A NASA também está conduzindo estudos detalhados sobre os efeitos do confinamento e do isolamento prolongado nos astronautas, informações cruciais para missões de longa duração e para a eventual construção de uma base lunar sustentável. Esses dados serão fundamentais para garantir a segurança e o bem-estar dos exploradores espaciais em futuras empreitadas.</p><p>Após completar sua órbita lunar e os testes planejados, a tripulação da Artemis II iniciará sua viagem de retorno à Terra. A fase de reentrada na atmosfera terrestre será um momento crítico, com a cápsula Orion realizando uma descida controlada. Em seguida, paraquedas serão acionados para desacelerar a espaçonave antes de seu mergulho final no Oceano Pacífico. Este procedimento de retorno é uma etapa vital para validar a segurança e a eficácia dos sistemas de pouso, garantindo que os astronautas possam retornar em segurança após suas missões no espaço profundo.</p><p>A Artemis II é um passo fundamental no programa Artemis da NASA, que visa estabelecer uma presença humana sustentada na Lua e, eventualmente, servir como trampolim para missões a Marte. A agência espacial planeja pousar astronautas na Lua com a missão Artemis IV, prevista para 2028, com o objetivo de construir uma infraestrutura que permita a permanência humana a longo prazo. Este ambicioso plano inclui o desenvolvimento de tecnologias avançadas e a colaboração com parceiros internacionais, pavimentando o caminho para uma nova era de descobertas e exploração interplanetária.</p><p>Bill Nye, CEO da The Planetary Society, expressou o sentimento de muitos ao afirmar que &quot;o lançamento da Artemis II irá entusiasmar e inspirar as pessoas em todos os lugares da Terra&quot;. A missão não apenas demonstra o avanço tecnológico e a capacidade de superação da humanidade, mas também reacende a paixão pela exploração e o desejo de desvendar os mistérios do universo. A jornada da Artemis II é um lembrete poderoso do que pode ser alcançado quando a ciência, a engenharia e a coragem se unem em prol de um objetivo comum.</p><p>À medida que a Artemis II prossegue em sua jornada histórica, o mundo observa com expectativa. Os dados coletados e as experiências vividas por esta tripulação pioneira serão inestimáveis para o futuro da exploração espacial. Cada etapa desta missão contribui para o conhecimento humano e para a capacidade de estender nossa presença além da Terra. A Artemis II não é apenas um voo ao redor da Lua; é um salto em direção a um futuro onde a humanidade se aventura mais profundamente no cosmos, impulsionada pela curiosidade e pelo espírito de descoberta.</p>",
    "body_pt": "<p>A missão Artemis II da NASA marcou um momento histórico na exploração espacial, enviando quatro astronautas em uma jornada de 10 dias ao redor da Lua. Este voo representa a primeira vez que seres humanos viajam em direção à órbita lunar em mais de meio século, desde a missão Apollo 17. Em 1º de abril, no horário de verão do leste (EDT), a missão Artemis II decolou do Centro Espacial Kennedy, em Cabo Canaveral, Flórida, com o objetivo principal de testar os sistemas da espaçonave Orion e os procedimentos de voo tripulado antes de futuras missões que incluirão o pouso de astronautas na superfície lunar. O sucesso deste lançamento é um testemunho da engenhosidade humana e da colaboração internacional, reafirmando o compromisso da humanidade com a exploração do espaço profundo.</p><p>A bordo da espaçonave Orion, a tripulação é composta por nomes que já fazem história. Christina Koch se tornou a primeira mulher a viajar em uma missão lunar, enquanto Victor Glover é o primeiro afro-americano a participar de um voo com destino à Lua. Jeremy Hansen, por sua vez, é o primeiro canadense a integrar uma missão lunar. A diversidade e a experiência desses astronautas sublinham a natureza global e inclusiva da nova era de exploração lunar, inspirando gerações futuras a olhar para as estrelas.</p><p>Durante os dez dias de missão, os astronautas realizarão uma série de testes críticos para avaliar o desempenho da Orion e a capacidade da tripulação de operar em um ambiente de espaço profundo. A espaçonave, que tem o tamanho aproximado de uma van de mudança, servirá como lar e laboratório para os quatro tripulantes. A NASA também está conduzindo estudos detalhados sobre os efeitos do confinamento e do isolamento prolongado nos astronautas, informações cruciais para missões de longa duração e para a eventual construção de uma base lunar sustentável. Esses dados serão fundamentais para garantir a segurança e o bem-estar dos exploradores espaciais em futuras empreitadas.</p><p>Após completar sua órbita lunar e os testes planejados, a tripulação da Artemis II iniciará sua viagem de retorno à Terra. A fase de reentrada na atmosfera terrestre será um momento crítico, com a cápsula Orion realizando uma descida controlada. Em seguida, paraquedas serão acionados para desacelerar a espaçonave antes de seu mergulho final no Oceano Pacífico. Este procedimento de retorno é uma etapa vital para validar a segurança e a eficácia dos sistemas de pouso, garantindo que os astronautas possam retornar em segurança após suas missões no espaço profundo.</p><p>A Artemis II é um passo fundamental no programa Artemis da NASA, que visa estabelecer uma presença humana sustentada na Lua e, eventualmente, servir como trampolim para missões a Marte. A agência espacial planeja pousar astronautas na Lua com a missão Artemis IV, prevista para 2028, com o objetivo de construir uma infraestrutura que permita a permanência humana a longo prazo. Este ambicioso plano inclui o desenvolvimento de tecnologias avançadas e a colaboração com parceiros internacionais, pavimentando o caminho para uma nova era de descobertas e exploração interplanetária.</p><p>Bill Nye, CEO da The Planetary Society, expressou o sentimento de muitos ao afirmar que &quot;o lançamento da Artemis II irá entusiasmar e inspirar as pessoas em todos os lugares da Terra&quot;. A missão não apenas demonstra o avanço tecnológico e a capacidade de superação da humanidade, mas também reacende a paixão pela exploração e o desejo de desvendar os mistérios do universo. A jornada da Artemis II é um lembrete poderoso do que pode ser alcançado quando a ciência, a engenharia e a coragem se unem em prol de um objetivo comum.</p><p>À medida que a Artemis II prossegue em sua jornada histórica, o mundo observa com expectativa. Os dados coletados e as experiências vividas por esta tripulação pioneira serão inestimáveis para o futuro da exploração espacial. Cada etapa desta missão contribui para o conhecimento humano e para a capacidade de estender nossa presença além da Terra. A Artemis II não é apenas um voo ao redor da Lua; é um salto em direção a um futuro onde a humanidade se aventura mais profundamente no cosmos, impulsionada pela curiosidade e pelo espírito de descoberta.</p>",
    ...
    "highlights": [
      "Em foco: A missão Artemis II da NASA enviou astronautas em uma jornada ao redor da Lua, marcando o primeiro voo tripulado lunar em mais de 50 anos e",
      "Detalhe: Origem institucional: distinguir anúncio de evidência",
      "Leitura editorial: reportagem científica; quando possível, confira a fonte primária citada."
    ],
    "highlights_pt": [
    ...
    "imageAlt": "Artemis II: Missão Tripulada Retorna à Órbita Lunar Após Mais de Meio Século",
    "imageAlt_pt": "Artemis II: Missão Tripulada Retorna à Órbita Lunar Após Mais de Meio Século",
  ...
  },
  {
    ...
    "sub": "A missão Artemis II, que representa a primeira viagem humana à órbita lunar desde 1972, foi lançada com sucesso às 00h35 CEST do dia 2 de abril de 2026.",
    "sub_pt": "A missão Artemis II, que representa a primeira viagem humana à órbita lunar desde 1972, foi lançada com sucesso às 00h35 CEST do dia 2 de abril de 2026.",
    ...
    "excerpt": "A missão Artemis II, que representa a primeira viagem humana à órbita lunar desde 1972, foi lançada com sucesso às 00h35 CEST do dia 2 de abril de 2026.",
    "excerpt_pt": "A missão Artemis II, que representa a primeira viagem humana à órbita lunar desde 1972, foi lançada com sucesso às 00h35 CEST do dia 2 de abril de 2026.",
    ...
    "body": "<p>A missão Artemis II da NASA foi lançada com sucesso às 00h35 CEST do dia 2 de abril de 2026, marcando um momento histórico como a primeira viagem tripulada às proximidades da Lua desde 1972. A bordo da espaçonave Orion, seis chips Timepix, desenvolvidos no CERN, desempenharão um papel crucial na medição do ambiente de radiação. Esta iniciativa sublinha a contínua colaboração internacional em exploração espacial e a importância da tecnologia de ponta para garantir a segurança das futuras missões lunares e além.</p><p>Durante a jornada de dez dias da missão Artemis II, os quatro astronautas a bordo da Orion estarão expostos a níveis de radiação que se esperam ser de dezenas de milisieverts. Este valor é mais de dez vezes superior ao que a maioria das pessoas experimenta em um ano inteiro na Terra, evidenciando os desafios inerentes às viagens espaciais profundas. Os chips Timepix são componentes essenciais do sistema Hybrid Electronic Radiation Assessor (HERA) da NASA, projetado especificamente para monitorar e avaliar o ambiente de radiação dentro da espaçonave, fornecendo dados vitais para a proteção da tripulação.</p><p>Os detectores Timepix foram desenvolvidos pela Medipix2 Collaboration, um consórcio hospedado pelo CERN, que se dedica ao projeto de tecnologias híbridas de detector de pixels para aplicações em imagem e medição de radiação. Para a missão Artemis II, a implementação desses sistemas baseados em Timepix foi realizada em colaboração com a ADVACAM, um parceiro do CERN especializado em tecnologias de imagem por contagem de fótons. Essa parceria estratégica garante que a tecnologia mais avançada esteja disponível para enfrentar os desafios únicos da medição de radiação no espaço profundo.</p><p>Diferentemente das missões em órbita baixa da Terra, como as realizadas na Estação Espacial Internacional (ISS), a Artemis II viajará para além da proteção oferecida pelo campo geomagnético terrestre. Essa distinção é fundamental, pois o campo magnético da Terra atua como um escudo natural contra a maior parte da radiação cósmica e das partículas solares. Ao se aventurar em um ambiente onde essa proteção é mínima, a espaçonave e sua tripulação ficam mais vulneráveis a partículas de alta energia, tornando o monitoramento preciso da radiação uma prioridade máxima para a segurança da missão.</p><p>Os dados coletados pelos chips Timepix serão cruciais para a compreensão dos riscos de radiação em missões de longa duração e para o desenvolvimento de contramedidas eficazes. Essas informações não apenas protegerão os astronautas da Artemis II, mas também servirão como base para o planejamento de futuras missões tripuladas ao espaço profundo, incluindo o retorno à superfície lunar e, eventualmente, a Marte. A capacidade de caracterizar com precisão o tipo e a quantidade de radiação é vital para projetar blindagens mais eficientes e protocolos de segurança aprimorados, garantindo a viabilidade e o sucesso da exploração espacial humana a longo prazo.</p><p>A participação do CERN na missão Artemis II exemplifica a relevância da pesquisa fundamental em física de partículas para avanços em outras áreas da ciência e tecnologia. A expertise desenvolvida na detecção de partículas de alta energia em aceleradores como o LHC é diretamente aplicável aos desafios da exploração espacial. Assim, a jornada dos chips Timepix para a Lua não é apenas um marco tecnológico, mas também um testemunho da interconexão entre diferentes campos da ciência na busca por expandir os limites do conhecimento humano e da presença da humanidade no cosmos.</p>",
    "body_pt": "<p>A missão Artemis II da NASA foi lançada com sucesso às 00h35 CEST do dia 2 de abril de 2026, marcando um momento histórico como a primeira viagem tripulada às proximidades da Lua desde 1972. A bordo da espaçonave Orion, seis chips Timepix, desenvolvidos no CERN, desempenharão um papel crucial na medição do ambiente de radiação. Esta iniciativa sublinha a contínua colaboração internacional em exploração espacial e a importância da tecnologia de ponta para garantir a segurança das futuras missões lunares e além.</p><p>Durante a jornada de dez dias da missão Artemis II, os quatro astronautas a bordo da Orion estarão expostos a níveis de radiação que se esperam ser de dezenas de milisieverts. Este valor é mais de dez vezes superior ao que a maioria das pessoas experimenta em um ano inteiro na Terra, evidenciando os desafios inerentes às viagens espaciais profundas. Os chips Timepix são componentes essenciais do sistema Hybrid Electronic Radiation Assessor (HERA) da NASA, projetado especificamente para monitorar e avaliar o ambiente de radiação dentro da espaçonave, fornecendo dados vitais para a proteção da tripulação.</p><p>Os detectores Timepix foram desenvolvidos pela Medipix2 Collaboration, um consórcio hospedado pelo CERN, que se dedica ao projeto de tecnologias híbridas de detector de pixels para aplicações em imagem e medição de radiação. Para a missão Artemis II, a implementação desses sistemas baseados em Timepix foi realizada em colaboração com a ADVACAM, um parceiro do CERN especializado em tecnologias de imagem por contagem de fótons. Essa parceria estratégica garante que a tecnologia mais avançada esteja disponível para enfrentar os desafios únicos da medição de radiação no espaço profundo.</p><p>Diferentemente das missões em órbita baixa da Terra, como as realizadas na Estação Espacial Internacional (ISS), a Artemis II viajará para além da proteção oferecida pelo campo geomagnético terrestre. Essa distinção é fundamental, pois o campo magnético da Terra atua como um escudo natural contra a maior parte da radiação cósmica e das partículas solares. Ao se aventurar em um ambiente onde essa proteção é mínima, a espaçonave e sua tripulação ficam mais vulneráveis a partículas de alta energia, tornando o monitoramento preciso da radiação uma prioridade máxima para a segurança da missão.</p><p>Os dados coletados pelos chips Timepix serão cruciais para a compreensão dos riscos de radiação em missões de longa duração e para o desenvolvimento de contramedidas eficazes. Essas informações não apenas protegerão os astronautas da Artemis II, mas também servirão como base para o planejamento de futuras missões tripuladas ao espaço profundo, incluindo o retorno à superfície lunar e, eventualmente, a Marte. A capacidade de caracterizar com precisão o tipo e a quantidade de radiação é vital para projetar blindagens mais eficientes e protocolos de segurança aprimorados, garantindo a viabilidade e o sucesso da exploração espacial humana a longo prazo.</p><p>A participação do CERN na missão Artemis II exemplifica a relevância da pesquisa fundamental em física de partículas para avanços em outras áreas da ciência e tecnologia. A expertise desenvolvida na detecção de partículas de alta energia em aceleradores como o LHC é diretamente aplicável aos desafios da exploração espacial. Assim, a jornada dos chips Timepix para a Lua não é apenas um marco tecnológico, mas também um testemunho da interconexão entre diferentes campos da ciência na busca por expandir os limites do conhecimento humano e da presença da humanidade no cosmos.</p>",
    ...
    "highlights": [
      "Em foco: A missão Artemis II, que representa a primeira viagem humana à órbita lunar desde 1972, foi lançada com sucesso às 00h35 CEST do dia 2 de abril de",
      "Detalhe: Origem institucional: distinguir anúncio de evidência",
      "Leitura editorial: release institucional, útil como fonte primária, mas não como validação independente."
    ],
    "highlights_pt": [
  ...
  },
  {
    ...
    "highlights": [
      "Em foco: Os astrónomos observaram dois planetas a formar-se no disco em torno de uma estrela jovem chamada WISPIT 2",
      "Detalhe: Origem institucional: distinguir anúncio de evidência",
      "Leitura editorial: release institucional, útil como fonte primária, mas não como validação independente."
    ],
    "highlights_pt": [
  ...
  },
  {
    ...
    "video": null,
    "audio": null,
    "title": "Hubble Captura Inesperadamente a Fragmentação de um Cometa",
    "title_pt": "Hubble Captura Inesperadamente a Fragmentação de um Cometa",
    "title_en": "Science Release: Hubble unexpectedly catches comet breaking up",
    "sub": "O Telescópio Espacial Hubble da NASA/ESA observou a inesperada fragmentação do Cometa C/2025 K1 (ATLAS) em pelo menos quatro pedaços, poucos dias após sua maior aproximação ao Sol.",
    "sub_pt": "O Telescópio Espacial Hubble da NASA/ESA observou a inesperada fragmentação do Cometa C/2025 K1 (ATLAS) em pelo menos quatro pedaços, poucos dias após sua maior aproximação ao Sol.",
    ...
    "excerpt": "O Telescópio Espacial Hubble da NASA/ESA observou a inesperada fragmentação do Cometa C/2025 K1 (ATLAS) em pelo menos quatro pedaços, poucos dias após sua maior aproximação ao Sol e enquanto ele se afastava do Sistema Solar.",
    "excerpt_pt": "O Telescópio Espacial Hubble da NASA/ESA observou a inesperada fragmentação do Cometa C/2025 K1 (ATLAS) em pelo menos quatro pedaços, poucos dias após sua maior aproximação ao Sol e enquanto ele se afastava do Sistema Solar.",
    ...
    "body": "<p>O Cometa C/2025 K1 (ATLAS), que não deve ser confundido com o cometa interestelar 3I/ATLAS, havia acabado de passar por sua maior aproximação ao Sol e estava em trajetória de saída do Sistema Solar. Embora estivesse intacto poucos dias antes, o cometa K1 fragmentou-se inesperadamente em pelo menos quatro pedaços enquanto era observado pelo Telescópio Espacial Hubble da NASA/ESA. Este evento transformou uma observação de rotina em uma oportunidade científica rara e valiosa. A equipe de pesquisa não tinha como prever a fragmentação, tornando a captura um golpe de sorte extraordinário para a astronomia.</p><p>A descoberta da fragmentação foi feita pelo pesquisador Noonan, que só percebeu o fenômeno ao analisar as imagens do Hubble um dia após sua captura. A surpresa foi imensa, pois a equipe havia sido forçada a encontrar um novo alvo para seu estudo, e a quebra do cometa logo após o início da observação representava uma chance mínima, quase improvável. Noonan descreveu a situação como &quot;algo muito, muito especial&quot;, destacando a singularidade do evento. Este tipo de observação, a fragmentação de um cometa em tempo real, era um experimento que os pesquisadores sempre desejaram realizar com o Hubble, e a natureza fortuita da descoberta apenas aumentou seu valor científico.</p><p>As imagens cruciais do Hubble foram obtidas apenas um mês após o periélio do cometa K1, o ponto de sua maior aproximação ao Sol. O periélio do cometa ocorreu dentro da órbita de Mercúrio, a uma distância de aproximadamente um terço da distância da Terra ao Sol. O telescópio registrou três imagens de 20 segundos cada, uma por dia, entre 8 e 10 de novembro de 2025. Essa sequência de observações permitiu aos cientistas documentar o processo de fragmentação em um curto período, fornecendo dados valiosos sobre a dinâmica e as forças que atuam sobre cometas em ambientes extremos próximos ao Sol.</p><p>Análises preliminares realizadas a partir da Terra já indicam que o cometa K1 possui uma composição química bastante peculiar. Em comparação com outros cometas estudados, o K1 apresenta um empobrecimento significativo em carbono. Essa característica o torna um objeto de grande interesse para a comunidade científica, pois a composição química de um cometa pode oferecer pistas importantes sobre as condições prevalecentes no Sistema Solar primordial. A raridade dessa composição sugere que o K1 pode ter se formado em uma região ou sob circunstâncias diferentes da maioria dos cometas conhecidos.</p><p>Para aprofundar o entendimento sobre a composição do K1 e, por extensão, as origens do nosso Sistema Solar, a análise espectroscópica será fundamental. Os instrumentos STIS (Space Telescope Imaging Spectrograph) e COS (Cosmic Origins Spectrograph) do Hubble estão programados para realizar essa investigação detalhada. Espera-se que esses dados revelem muito mais sobre os elementos e moléculas presentes nos fragmentos do cometa, permitindo aos cientistas reconstruir sua história e seu ambiente de formação. Atualmente, o Cometa K1 existe como uma coleção de fragmentos dispersos a cerca de 400 milhões de quilômetros da Terra, cada pedaço oferecendo uma janela para o passado cósmico.</p>",
    "body_pt": "<p>O Cometa C/2025 K1 (ATLAS), que não deve ser confundido com o cometa interestelar 3I/ATLAS, havia acabado de passar por sua maior aproximação ao Sol e estava em trajetória de saída do Sistema Solar. Embora estivesse intacto poucos dias antes, o cometa K1 fragmentou-se inesperadamente em pelo menos quatro pedaços enquanto era observado pelo Telescópio Espacial Hubble da NASA/ESA. Este evento transformou uma observação de rotina em uma oportunidade científica rara e valiosa. A equipe de pesquisa não tinha como prever a fragmentação, tornando a captura um golpe de sorte extraordinário para a astronomia.</p><p>A descoberta da fragmentação foi feita pelo pesquisador Noonan, que só percebeu o fenômeno ao analisar as imagens do Hubble um dia após sua captura. A surpresa foi imensa, pois a equipe havia sido forçada a encontrar um novo alvo para seu estudo, e a quebra do cometa logo após o início da observação representava uma chance mínima, quase improvável. Noonan descreveu a situação como &quot;algo muito, muito especial&quot;, destacando a singularidade do evento. Este tipo de observação, a fragmentação de um cometa em tempo real, era um experimento que os pesquisadores sempre desejaram realizar com o Hubble, e a natureza fortuita da descoberta apenas aumentou seu valor científico.</p><p>As imagens cruciais do Hubble foram obtidas apenas um mês após o periélio do cometa K1, o ponto de sua maior aproximação ao Sol. O periélio do cometa ocorreu dentro da órbita de Mercúrio, a uma distância de aproximadamente um terço da distância da Terra ao Sol. O telescópio registrou três imagens de 20 segundos cada, uma por dia, entre 8 e 10 de novembro de 2025. Essa sequência de observações permitiu aos cientistas documentar o processo de fragmentação em um curto período, fornecendo dados valiosos sobre a dinâmica e as forças que atuam sobre cometas em ambientes extremos próximos ao Sol.</p><p>Análises preliminares realizadas a partir da Terra já indicam que o cometa K1 possui uma composição química bastante peculiar. Em comparação com outros cometas estudados, o K1 apresenta um empobrecimento significativo em carbono. Essa característica o torna um objeto de grande interesse para a comunidade científica, pois a composição química de um cometa pode oferecer pistas importantes sobre as condições prevalecentes no Sistema Solar primordial. A raridade dessa composição sugere que o K1 pode ter se formado em uma região ou sob circunstâncias diferentes da maioria dos cometas conhecidos.</p><p>Para aprofundar o entendimento sobre a composição do K1 e, por extensão, as origens do nosso Sistema Solar, a análise espectroscópica será fundamental. Os instrumentos STIS (Space Telescope Imaging Spectrograph) e COS (Cosmic Origins Spectrograph) do Hubble estão programados para realizar essa investigação detalhada. Espera-se que esses dados revelem muito mais sobre os elementos e moléculas presentes nos fragmentos do cometa, permitindo aos cientistas reconstruir sua história e seu ambiente de formação. Atualmente, o Cometa K1 existe como uma coleção de fragmentos dispersos a cerca de 400 milhões de quilômetros da Terra, cada pedaço oferecendo uma janela para o passado cósmico.</p>",
    ...
    "highlights": [
      "Em foco: O Telescópio Espacial Hubble da NASA/ESA observou a inesperada fragmentação do Cometa C/2025 K1 (ATLAS) em pelo menos quatro pedaços, poucos dias",
      "Detalhe: Origem institucional: distinguir anúncio de evidência",
      "Leitura editorial: release institucional, útil como fonte primária, mas não como validação independente."
    ],
    "highlights_pt": [
    ...
    "imageAlt": "Hubble Captura Inesperadamente a Fragmentação de um Cometa",
    "imageAlt_pt": "Hubble Captura Inesperadamente a Fragmentação de um Cometa",
