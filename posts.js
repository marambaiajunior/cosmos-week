...
window.postsData = [
  {
    ...
    "highlights": [
      "Em foco: Entre 11 e 12 de agosto, o Lunar Reconnaissance Orbiter da NASA capturou uma série de imagens de uma nova cratera na Lua",
  ...
  },
  {
    ...
    "video": null,
    "audio": null,
    "title": "Linhas infravermelhas de momentos magnéticos de transição estéril-neutrino no JWST",
    "title_pt": "Linhas infravermelhas de momentos magnéticos de transição estéril-neutrino no JWST",
    "title_en": "Infrared Lines from Sterile-Neutrino Transition Magnetic Moments at JWST",
    "sub": "Investigamos assinaturas de linhas infravermelhas de matéria escura de neutrinos estéreis em decomposição radiativa usando observações de céu branco JWST/NIRSpec IFU disponíveis.",
    "sub_pt": "Investigamos assinaturas de linhas infravermelhas de matéria escura de neutrinos estéreis em decomposição radiativa usando observações de céu branco JWST/NIRSpec IFU disponíveis.",
    "sub_en": "We investigate infrared line signatures from radiatively decaying sterile-neutrino dark matter using publicly available JWST/NIRSpec IFU blank-sky observations.",
    "excerpt": "Investigamos assinaturas de linhas infravermelhas de matéria escura de neutrinos estéreis em decomposição radiativa usando observações de céu branco JWST/NIRSpec IFU disponíveis publicamente.",
    "excerpt_pt": "Investigamos assinaturas de linhas infravermelhas de matéria escura de neutrinos estéreis em decomposição radiativa usando observações de céu branco JWST/NIRSpec IFU disponíveis publicamente.",
    "excerpt_en": "We investigate infrared line signatures from radiatively decaying sterile-neutrino dark matter using publicly available JWST/NIRSpec IFU blank-sky observations.",
    "body": "<p>Investigamos assinaturas de linhas infravermelhas de matéria escura de neutrinos estéreis em decomposição radiativa usando observações de céu branco JWST/NIRSpec IFU disponíveis publicamente. O principal sinal considerado é a transição estéril para estéril $N_1\\to N_2γ$, induzida pelo coeficiente dipolo magnético de transição $d_{NNγ}$, com $m_1&gt;m_2$.</p><p>Em contraste com os decaimentos comuns de dois fótons de partículas do tipo axion ou do tipo Majoron, a energia do fóton observada não é fixada pela massa total da matéria escura, mas pela pequena divisão da massa $Δm=m_1-m_2$. Assim, um estado de matéria escura de neutrinos estéreis em escala keV pode gerar uma linha de fótons infravermelhos em escala eV na banda JWST.</p><p>Construímos uma análise de pesquisa de linha baseada em $χ^2$ usando os dados de céu branco do NIRSpec IFU $\\rm F170LP$-$\\rm G235M$ em direção a $\\rm GN\\text{-}z11$, modelando o continuum suave com um spline cúbico e incluindo o fluxo de decaimento do halo da Via Láctea. Na ausência de um excesso significativo, derivamos limites projetados em $d_{NNγ}$ e na largura de decaimento $Γ_{N_1\\to N_2γ}$ para $0, 1~{\\rm eV}\\lesssimΔm\\lesssim1~{\\rm eV}$.</p><p>Para um componente estéril que satura a abundância de matéria escura, a sensibilidade mais forte atinge $d_{NNγ}\\lesssim7\\times10^{-14}~{\\rm GeV}^{-1}$ e $Γ_{N_1\\to N_2γ}\\lesssim10^{-25}~{\\rm s}^{-1}$. Também incluímos um benchmark anômalo mínimo de Majoron, $ω\\toγγ$, obtendo sensibilidade JWST para $λ_{ωγγ}\\sim10^{-11}$-$10^{-9}~{\\rm GeV}^{-1}$ para $m_ω\\sim0.6$-$1~{\\rm eV}$.</p><p>Tanto indivíduos como organizações que trabalham com arXivLabs abraçaram e aceitaram nossos valores de abertura, comunidade, excelência e privacidade dos dados do usuário. ArXiv está comprometido com esses valores e só trabalha com parceiros que os aderem.</p><p>Tem uma ideia de um projeto que agregue valor à comunidade arXiv? .</p><p class=\"art-source\"><a href=\"https://arxiv.org/abs/2608.17679v1\" target=\"_blank\" rel=\"noopener noreferrer\">Fonte</a></p>",
    "body_pt": "<p>Investigamos assinaturas de linhas infravermelhas de matéria escura de neutrinos estéreis em decomposição radiativa usando observações de céu branco JWST/NIRSpec IFU disponíveis publicamente. O principal sinal considerado é a transição estéril para estéril $N_1\\to N_2γ$, induzida pelo coeficiente dipolo magnético de transição $d_{NNγ}$, com $m_1&gt;m_2$.</p><p>Em contraste com os decaimentos comuns de dois fótons de partículas do tipo axion ou do tipo Majoron, a energia do fóton observada não é fixada pela massa total da matéria escura, mas pela pequena divisão da massa $Δm=m_1-m_2$. Assim, um estado de matéria escura de neutrinos estéreis em escala keV pode gerar uma linha de fótons infravermelhos em escala eV na banda JWST.</p><p>Construímos uma análise de pesquisa de linha baseada em $χ^2$ usando os dados de céu branco do NIRSpec IFU $\\rm F170LP$-$\\rm G235M$ em direção a $\\rm GN\\text{-}z11$, modelando o continuum suave com um spline cúbico e incluindo o fluxo de decaimento do halo da Via Láctea. Na ausência de um excesso significativo, derivamos limites projetados em $d_{NNγ}$ e na largura de decaimento $Γ_{N_1\\to N_2γ}$ para $0, 1~{\\rm eV}\\lesssimΔm\\lesssim1~{\\rm eV}$.</p><p>Para um componente estéril que satura a abundância de matéria escura, a sensibilidade mais forte atinge $d_{NNγ}\\lesssim7\\times10^{-14}~{\\rm GeV}^{-1}$ e $Γ_{N_1\\to N_2γ}\\lesssim10^{-25}~{\\rm s}^{-1}$. Também incluímos um benchmark anômalo mínimo de Majoron, $ω\\toγγ$, obtendo sensibilidade JWST para $λ_{ωγγ}\\sim10^{-11}$-$10^{-9}~{\\rm GeV}^{-1}$ para $m_ω\\sim0.6$-$1~{\\rm eV}$.</p><p>Tanto indivíduos como organizações que trabalham com arXivLabs abraçaram e aceitaram nossos valores de abertura, comunidade, excelência e privacidade dos dados do usuário. ArXiv está comprometido com esses valores e só trabalha com parceiros que os aderem.</p><p>Tem uma ideia de um projeto que agregue valor à comunidade arXiv? .</p><p class=\"art-source\"><a href=\"https://arxiv.org/abs/2608.17679v1\" target=\"_blank\" rel=\"noopener noreferrer\">Fonte</a></p>",
    "body_en": "<p>We investigate infrared line signatures from radiatively decaying sterile-neutrino dark matter using publicly available JWST/NIRSpec IFU blank-sky observations. The new analysis still awaits peer review, but it already lays out the central claim clearly.</p><p>The significance lies in cosmology operates at the edge of what current instruments can measure, where systematic errors and model assumptions are never trivial. Small discrepancies between independent measurements have historically pointed toward missing physics rather than simple calibration errors, and the ongoing tension in the Hubble constant is a live example of how a persistent disagreement between methods can reshape the theoretical landscape. Each new dataset that approaches this territory with independent systematics adds real information to a problem that has resisted easy resolution for more than a decade. The main signal considered is the sterile-to-sterile transition $N_1\\to N_2γ$, induced by the transition magnetic dipole coefficient $d_{NNγ}$, with $m_1&gt;m_2$. In contrast to ordinary two-photon decays of axion-like or Majoron-like particles, the observed photon energy is not fixed by the full dark matter mass, but by the small mass.</p><p>Thus, a keV-scale sterile-neutrino dark matter state can generate an eV-scale infrared photon line in the JWST band. In the absence of a significant excess, we derive projected limits on $d_{NNγ}$ and on the decay width $Γ_{N_1\\to N_2γ}$ for $0.1~{\\rm eV}\\lesssimΔm\\lesssim1~{\\rm eV}$.</p><p>For a sterile component saturating the dark matter abundance, the strongest sensitivity reaches $d_{NNγ}\\lesssim7\\times10^{-14}~{\\rm GeV}^{-1}$ and $Γ_{N_1\\to. We also include a minimal anomalous-Majoron benchmark, $ω\\toγγ$, obtaining JWST sensitivity to $λ_{ωγγ}\\sim10^{-11}$-$10^{-9}~{\\rm GeV}^{-1}$ for $m_ω\\sim0.6$-$1~{\\rm eV}$.</p><p>Both individuals and organizations that work with arXivLabs have embraced and accepted our values of openness, community, excellence, and user data privacy. ArXiv is committed to these values and only works with partners that adhere to them.</p><p>The relevance goes beyond one dataset because even small shifts in measured parameters can matter when the field is testing the limits of the standard cosmological model. The Lambda-CDM framework describes the observable universe with remarkable economy, but its success rests on two components, dark matter and dark energy, whose physical nature remains entirely unknown. Any credible measurement that tightens or loosens the constraints on those components moves the entire theoretical enterprise forward, regardless of whether the immediate result looks dramatic on its own terms.</p><p>Have an idea for a project that will add value for arXiv&#x27;s community.</p><p>Because this is still a preprint, the result should be read with genuine interest and proportionate caution. Peer review is not a guarantee of correctness, but it is a process that forces authors to respond to technical criticism from specialists who have no stake in a particular outcome. Preprints that survive that process, often with substantive revisions, emerge with a stronger evidential base than the version that first appeared. Until that stage is complete, the responsible reading keeps uncertainty explicitly visible rather than treating the claims as established findings.</p><p>The next step is to see whether the effect survives when independent surveys, different calibration strategies and tighter control of systematic uncertainties enter the picture. Programmes such as Euclid, DESI and the Rubin Observatory will deliver datasets over the next several years that cover the same parameter space with largely independent methods. If the current signal persists through those tests, its theoretical implications will become impossible to set aside. Until peer review and independent follow-up address those open questions, skepticism is not a failure of appreciation for the work; it is part of how science decides what to keep.</p><p class=\"art-source\"><a href=\"https://arxiv.org/abs/2608.17679v1\" target=\"_blank\" rel=\"noopener noreferrer\">Source</a></p>",
    "highlights": [
    ...
    "highlights_en": [
      "Focus: We investigate infrared line signatures from radiatively decaying sterile-neutrino dark matter using publicly available JWST/NIRSpec IFU blank-sky",
    ...
    "read_pt": "4 min de leitura",
    "read_en": "4 min read",
    "publishedIso": "2026-08-18T11:51:13+00:00",
    "lastModifiedIso": "2026-08-19T16:17:19+00:00",
    ...
    "keywords": [
      ...
      "arXiv Cosmology",
      "Cosmos Week",
      "Linhas infravermelhas de momentos magnéticos de transição estéril",
      "neutrino no JWST"
    ],
    "keywords_pt": [
      "Cosmologia",
    ...
    "keywords_en": [
      ...
      "arXiv Cosmology",
      "Cosmos Week",
      "Infrared lines of sterile transition magnetic moments",
      "neutrino no JWST"
    ],
    "srcUrl": "https://arxiv.org/abs/2608.17679v1",
    "realUrl": "https://www.cosmosweek.com/?article=infrared-lines-from-sterile-neutrino-transition-magnetic-moments-at-jwst",
    "realUrl_pt": "https://www.cosmosweek.com/?article=infrared-lines-from-sterile-neutrino-transition-magnetic-moments-at-jwst",
    "realUrl_en": "https://www.cosmosweek.com/?article=infrared-lines-from-sterile-neutrino-transition-magnetic-moments-at-jwst&lang=en",
    "shareUrl": "https://www.cosmosweek.com/noticia/infrared-lines-from-sterile-neutrino-transition-magnetic-moments-at-jwst/",
    "shareUrl_pt": "https://www.cosmosweek.com/noticia/infrared-lines-from-sterile-neutrino-transition-magnetic-moments-at-jwst/",
    "shareUrl_en": "https://www.cosmosweek.com/en/news/infrared-lines-from-sterile-neutrino-transition-magnetic-moments-at-jwst/",
    "canonicalUrl": "https://www.cosmosweek.com/noticia/infrared-lines-from-sterile-neutrino-transition-magnetic-moments-at-jwst/",
    "canonicalUrl_pt": "https://www.cosmosweek.com/noticia/infrared-lines-from-sterile-neutrino-transition-magnetic-moments-at-jwst/",
    "canonicalUrl_en": "https://www.cosmosweek.com/en/news/infrared-lines-from-sterile-neutrino-transition-magnetic-moments-at-jwst/",
    "defaultLanguage": "pt-BR",
    "availableLanguages": [
      "pt-BR",
      "en-US"
    ...
    "imageAlt": "Linhas infravermelhas de momentos magnéticos de transição estéril-neutrino no JWST",
    "imageAlt_pt": "Linhas infravermelhas de momentos magnéticos de transição estéril-neutrino no JWST",
    "imageAlt_en": "Infrared Lines from Sterile-Neutrino Transition Magnetic Moments at JWST",
  ...
  },
  {
    ...
    "highlights": [
      "Em foco: Resultados recentes do Event Horizon Telescope demonstraram uma ciência única e transformadora na física gravitacional e na astrofísica de buracos",
      "Detalhe: Resultado ainda sem revisão por pares",
      "Leitura editorial: resultado provisório, ainda sem revisão por pares formal."
    ],
    "highlights_pt": [
    ...
    "highlights_en": [
      "Focus: Recent Event Horizon Telescope results have demonstrated unique and transformative science in gravitational physics and black hole astrophysics",
      "Editorial reading: provisional result, not yet formally peer reviewed."
    ],
    "date": "17 ago 2026",
    "date_pt": "17 ago 2026",
  ...
  },
  {
    ...
    "highlights": [
      ...
      "Dado-chave: À medida que a NASA se prepara para estabelecer a Base Lunar, o avanço da mobilidade na superfície será fundamental para ajudar as tripulações e.",
    ...
    "highlights_en": [
      ...
      "Key detail: As NASA prepares to establish the Moon Base, advancing surface mobility will be key to helping crews and robotic systems travel farther across.",
