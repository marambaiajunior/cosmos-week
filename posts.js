...
window.postsData = [
  ...
  },
  {
    ...
    "highlights": [
      ...
      "Dado-chave: Modelos de ondas oceânicas são cruciais para a previsão do tempo e do clima, e observações in situ precisas são fundamentais para sua validação e",
  ...
  },
  {
    ...
    "highlights": [
      "Em foco: A origem da superpartícula, e a hipótese de sua produção por um buraco negro primordial, ainda são objeto de debate na comunidade científica",
      "Detalhe: Cobertura jornalística: verificar documentação técnica primária",
      "Leitura editorial: reportagem científica; quando possível, confira a fonte primária citada."
    ],
    "highlights_pt": [
