...
window.postsData = [
  {
    ...
    "highlights": [
      "Em foco: Aprenda a utilizar o Satellite Data Explorer (SDX) para pesquisar, acessar e gerenciar aquisições de dados comerciais de observação da Terra",
  ...
  },
  {
    ...
    "highlights": [
      "Em foco: A questão sobre a precedência entre galáxias e buracos negros supermassivos tem sido um tema central na astrofísica",
      "Detalhe: Origem institucional: distinguir anúncio de evidência",
      "Leitura editorial: release institucional, útil como fonte primária, mas não como validação independente."
    ],
    "highlights_pt": [
  ...
  {
    "id": 4,
    "slug": "gwtc-5-0-constraints-on-the-cosmic-expansion-rate-and-modified-gravitational-wave-propagation",
    "cat": "Cosmologia",
    "catCls": "cosmologia",
    ...
    "video": null,
    "audio": null,
    "title": "GWTC-5.0: Restrições na taxa de expansão cósmica e propagação de ondas gravitacionais modificadas",
    "title_pt": "GWTC-5.0: Restrições na taxa de expansão cósmica e propagação de ondas gravitacionais modificadas",
    "title_en": "GWTC-5.0: Constraints on the Cosmic Expansion Rate and Modified Gravitational-wave Propagation",
    "sub": "Utilizamos 236 fontes de ondas gravitacionais do quinto Catálogo Transiente de Ondas Gravitacionais da Colaboração LIGO--Virgo--KAGRA (GWTC-5.",
    "sub_pt": "Utilizamos 236 fontes de ondas gravitacionais do quinto Catálogo Transiente de Ondas Gravitacionais da Colaboração LIGO--Virgo--KAGRA (GWTC-5.",
    "sub_en": "We employ 236 gravitational-wave sources in the fifth LIGO--Virgo--KAGRA Collaboration Gravitational-Wave Transient Catalog to estimate the Hubble constant $H_0$.",
    "excerpt": "Utilizamos 236 fontes de ondas gravitacionais do quinto Catálogo Transiente de Ondas Gravitacionais da Colaboração LIGO--Virgo--KAGRA (GWTC-5.",
    "excerpt_pt": "Utilizamos 236 fontes de ondas gravitacionais do quinto Catálogo Transiente de Ondas Gravitacionais da Colaboração LIGO--Virgo--KAGRA (GWTC-5.",
    "excerpt_en": "We employ 236 gravitational-wave sources in the fifth LIGO--Virgo--KAGRA Collaboration Gravitational-Wave Transient Catalog to estimate the Hubble constant $H_0$.",
    "body": "<p>Este estudo emprega um conjunto de 236 fontes de ondas gravitacionais (GW) provenientes do quinto Catálogo Transiente de Ondas Gravitacionais da Colaboração LIGO--Virgo--KAGRA (LVK), conhecido como GWTC-5.0, com o objetivo primordial de estimar a constante de Hubble ($H_0$). A determinação precisa de $H_0$ é crucial para a cosmologia, pois quantifica a taxa atual de expansão do universo e é um parâmetro fundamental para o modelo cosmológico padrão. A abordagem central envolve a comparação das distâncias de luminosidade, medidas a partir dos sinais de ondas gravitacionais, com os redshifts inferidos por métodos complementares. Esta metodologia permite explorar a relação entre a distância e o redshift, fornecendo restrições valiosas sobre os parâmetros cosmológicos.</p><p>Para inferir o redshift das fontes de ondas gravitacionais, foram utilizadas duas estratégias distintas. Primeiramente, empregou-se a análise de características presentes no espectro de massa das fontes, que podem ser correlacionadas com o redshift. Em segundo lugar, recorreu-se à associação estatística com galáxias hospedeiras potenciais, utilizando catálogos de galáxias para identificar possíveis anfitriãs para os eventos de ondas gravitacionais. A combinação dessas abordagens visa mitigar incertezas e fornecer uma estimativa mais robusta do redshift, essencial para a calibração da relação distância-redshift e, consequentemente, para a obtenção de restrições precisas nos parâmetros cosmológicos, incluindo $H_0$.</p><p>A estimativa da constante de Hubble apresentada neste trabalho integra diversas fontes de informação. Ela combina dados da distribuição de massa no referencial da fonte com a medição de $H_0$ obtida a partir do evento GW170817 e sua contraparte eletromagnética, que forneceu uma &#x27;sirene padrão&#x27; com redshift conhecido. Adicionalmente, foram incorporadas informações do catálogo de galáxias do Dark Energy Survey Year 6 (DES-Y6), que contribui para a associação estatística de galáxias hospedeiras e para a compreensão da distribuição de matéria em larga escala. Essa integração de dados multifacetados é fundamental para aprimorar a precisão e a confiabilidade da estimativa de $H_0$.</p><p>A partir da análise combinada, estimamos a constante de Hubble em $H_0 = {71, 0}_{-7, 1}^{+9, 0}\\, {\\text{km}\\, \\text{s}^{-1}\\, \\text{Mpc}^{-1}}$. Este valor representa a mediana da distribuição de probabilidade, acompanhada por um intervalo de credibilidade simétrico de $68\\%$. A incerteza associada reflete as limitações dos dados e dos modelos atuais, mas a precisão alcançada demonstra o potencial das ondas gravitacionais como sondas cosmológicas independentes. Esta medição contribui para o debate em curso sobre a tensão de Hubble, que se refere à discrepância entre as medições de $H_0$ obtidas por diferentes métodos cosmológicos, como os baseados no fundo cósmico de micro-ondas e os baseados em supernovas tipo Ia.</p><p>A capacidade de utilizar ondas gravitacionais para inferir parâmetros cosmológicos, como $H_0$, abre novas perspectivas para a cosmologia observacional. As &#x27;sirenes padrão&#x27; de ondas gravitacionais oferecem uma forma independente de medir distâncias cosmológicas, complementando as técnicas eletromagnéticas tradicionais. A contínua acumulação de eventos de ondas gravitacionais por detectores como LIGO, Virgo e KAGRA, juntamente com o aprimoramento das metodologias de análise, promete refinar ainda mais essas medições. Tais avanços são cruciais para testar modelos cosmológicos, investigar a natureza da energia escura e da matéria escura, e compreender a evolução do universo em diferentes épocas.</p><p>É importante ressaltar que os resultados apresentados neste estudo são preliminares e ainda não foram submetidos ao processo de revisão por pares. A revisão por pares é uma etapa essencial no processo científico, garantindo a validação da metodologia, a robustez das análises e a interpretação dos resultados pela comunidade científica. Futuras análises e a incorporação de um número ainda maior de eventos de ondas gravitacionais, bem como o refinamento dos modelos teóricos e das técnicas de inferência, serão fundamentais para consolidar e aprimorar estas restrições na taxa de expansão cósmica e na propagação de ondas gravitacionais modificadas.</p>",
    "body_pt": "<p>Este estudo emprega um conjunto de 236 fontes de ondas gravitacionais (GW) provenientes do quinto Catálogo Transiente de Ondas Gravitacionais da Colaboração LIGO--Virgo--KAGRA (LVK), conhecido como GWTC-5.0, com o objetivo primordial de estimar a constante de Hubble ($H_0$). A determinação precisa de $H_0$ é crucial para a cosmologia, pois quantifica a taxa atual de expansão do universo e é um parâmetro fundamental para o modelo cosmológico padrão. A abordagem central envolve a comparação das distâncias de luminosidade, medidas a partir dos sinais de ondas gravitacionais, com os redshifts inferidos por métodos complementares. Esta metodologia permite explorar a relação entre a distância e o redshift, fornecendo restrições valiosas sobre os parâmetros cosmológicos.</p><p>Para inferir o redshift das fontes de ondas gravitacionais, foram utilizadas duas estratégias distintas. Primeiramente, empregou-se a análise de características presentes no espectro de massa das fontes, que podem ser correlacionadas com o redshift. Em segundo lugar, recorreu-se à associação estatística com galáxias hospedeiras potenciais, utilizando catálogos de galáxias para identificar possíveis anfitriãs para os eventos de ondas gravitacionais. A combinação dessas abordagens visa mitigar incertezas e fornecer uma estimativa mais robusta do redshift, essencial para a calibração da relação distância-redshift e, consequentemente, para a obtenção de restrições precisas nos parâmetros cosmológicos, incluindo $H_0$.</p><p>A estimativa da constante de Hubble apresentada neste trabalho integra diversas fontes de informação. Ela combina dados da distribuição de massa no referencial da fonte com a medição de $H_0$ obtida a partir do evento GW170817 e sua contraparte eletromagnética, que forneceu uma &#x27;sirene padrão&#x27; com redshift conhecido. Adicionalmente, foram incorporadas informações do catálogo de galáxias do Dark Energy Survey Year 6 (DES-Y6), que contribui para a associação estatística de galáxias hospedeiras e para a compreensão da distribuição de matéria em larga escala. Essa integração de dados multifacetados é fundamental para aprimorar a precisão e a confiabilidade da estimativa de $H_0$.</p><p>A partir da análise combinada, estimamos a constante de Hubble em $H_0 = {71, 0}_{-7, 1}^{+9, 0}\\, {\\text{km}\\, \\text{s}^{-1}\\, \\text{Mpc}^{-1}}$. Este valor representa a mediana da distribuição de probabilidade, acompanhada por um intervalo de credibilidade simétrico de $68\\%$. A incerteza associada reflete as limitações dos dados e dos modelos atuais, mas a precisão alcançada demonstra o potencial das ondas gravitacionais como sondas cosmológicas independentes. Esta medição contribui para o debate em curso sobre a tensão de Hubble, que se refere à discrepância entre as medições de $H_0$ obtidas por diferentes métodos cosmológicos, como os baseados no fundo cósmico de micro-ondas e os baseados em supernovas tipo Ia.</p><p>A capacidade de utilizar ondas gravitacionais para inferir parâmetros cosmológicos, como $H_0$, abre novas perspectivas para a cosmologia observacional. As &#x27;sirenes padrão&#x27; de ondas gravitacionais oferecem uma forma independente de medir distâncias cosmológicas, complementando as técnicas eletromagnéticas tradicionais. A contínua acumulação de eventos de ondas gravitacionais por detectores como LIGO, Virgo e KAGRA, juntamente com o aprimoramento das metodologias de análise, promete refinar ainda mais essas medições. Tais avanços são cruciais para testar modelos cosmológicos, investigar a natureza da energia escura e da matéria escura, e compreender a evolução do universo em diferentes épocas.</p><p>É importante ressaltar que os resultados apresentados neste estudo são preliminares e ainda não foram submetidos ao processo de revisão por pares. A revisão por pares é uma etapa essencial no processo científico, garantindo a validação da metodologia, a robustez das análises e a interpretação dos resultados pela comunidade científica. Futuras análises e a incorporação de um número ainda maior de eventos de ondas gravitacionais, bem como o refinamento dos modelos teóricos e das técnicas de inferência, serão fundamentais para consolidar e aprimorar estas restrições na taxa de expansão cósmica e na propagação de ondas gravitacionais modificadas.</p>",
    "body_en": "<p>We employ 236 gravitational-wave sources in the fifth LIGO--Virgo--KAGRA Collaboration Gravitational-Wave Transient Catalog to estimate the Hubble constant $H_0$. The new analysis still awaits peer review, but it already lays out the central claim clearly.</p><p>It matters because cosmology operates at the edge of what current instruments can measure, where systematic errors and model assumptions are never trivial. Small discrepancies between independent measurements have historically pointed toward missing physics rather than simple calibration errors, and the ongoing tension in the Hubble constant is a live example of how a persistent disagreement between methods can reshape the theoretical landscape. Each new dataset that approaches this territory with independent systematics adds real information to a problem that has resisted easy resolution for more than a decade. We employ 236 gravitational-wave (GW) sources in the fifth LIGO--Virgo--KAGRA Collaboration (LVK) Gravitational-Wave Transient Catalog (GWTC-5. Both individuals and organizations that work with arXivLabs have embraced and accepted our values of openness, community, excellence, and user data privacy.</p><p>ArXiv is committed to these values and only works with partners that adhere to them. Have an idea for a project that will add value for arXiv&#x27;s community.</p><p>We compare the luminosity distance measured from GWs to the redshift inferred i) using features in the mass spectrum, and ii) using statistical host galaxy association. Probing the relationship between source luminosity distances and redshifts obtained in this way yields constraints on cosmological parameters.</p><p>We estimate $H_0 = {71.0}_{-7.1}^{+9.0}\\, {\\text{km}\\, \\text{s}^{-1}\\, \\text{Mpc}^{-1}}$ (median with $68\\%$ symmetric credible interval). This combines information from the source-frame mass distribution with the $H_0$ measurement from GW170817 and its electromagnetic counterpart as well as galaxy catalog.</p><p>The relevance goes beyond one dataset because even small shifts in measured parameters can matter when the field is testing the limits of the standard cosmological model. The Lambda-CDM framework describes the observable universe with remarkable economy, but its success rests on two components, dark matter and dark energy, whose physical nature remains entirely unknown. Any credible measurement that tightens or loosens the constraints on those components moves the entire theoretical enterprise forward, regardless of whether the immediate result looks dramatic on its own terms.</p><p>We improve over the GWTC-4.0 measurement by using more GW sources, some with significantly smaller sky localization volumes, which leads to a reduction by $25. We also constrain deviations from general relativity (GR) which affect GW propagation, specifically that modify the luminosity distance inferred from the GW signal.</p><p>Because this is still a preprint, the result should be read with genuine interest and proportionate caution. Peer review is not a guarantee of correctness, but it is a process that forces authors to respond to technical criticism from specialists who have no stake in a particular outcome. Preprints that survive that process, often with substantive revisions, emerge with a stronger evidential base than the version that first appeared. Until that stage is complete, the responsible reading keeps uncertainty explicitly visible rather than treating the claims as established findings.</p><p>The next step is to see whether the effect survives when independent surveys, different calibration strategies and tighter control of systematic uncertainties enter the picture. Programmes such as Euclid, DESI and the Rubin Observatory will deliver datasets over the next several years that cover the same parameter space with largely independent methods. If the current signal persists through those tests, its theoretical implications will become impossible to set aside. Until peer review and independent follow-up address those open questions, skepticism is not a failure of appreciation for the work; it is part of how science decides what to keep.</p><p class=\"art-source\"><a href=\"https://arxiv.org/abs/2605.27227v1\" target=\"_blank\" rel=\"noopener noreferrer\">Source</a></p>",
    "highlights": [
    ...
    "highlights_en": [
      "Focus: We employ 236 gravitational-wave sources in the fifth LIGO--Virgo--KAGRA Collaboration Gravitational-Wave Transient Catalog to estimate the Hubble",
    ...
    "read_pt": "4 min de leitura",
    "read_en": "4 min read",
    "publishedIso": "2026-05-26T16:09:51+00:00",
    "lastModifiedIso": "2026-05-27T18:24:51+00:00",
    ...
    "keywords": [
      ...
      "Cosmos Week",
      "GWTC",
      "Restrições na taxa de expansão cósmica e propagação de ondas gravitacionais modificadas"
    ],
    "keywords_pt": [
      "Cosmologia",
      "arXiv Cosmology",
    ...
    "keywords_en": [
      ...
      "Cosmos Week",
      "GWTC",
      "Constraints on the rate of cosmic expansion and propagation of modified gravitational waves"
    ],
    "srcUrl": "https://arxiv.org/abs/2605.27227v1",
    "realUrl": "https://www.cosmosweek.com/?article=gwtc-5-0-constraints-on-the-cosmic-expansion-rate-and-modified-gravitational-wave-propagation",
    "realUrl_pt": "https://www.cosmosweek.com/?article=gwtc-5-0-constraints-on-the-cosmic-expansion-rate-and-modified-gravitational-wave-propagation",
    "realUrl_en": "https://www.cosmosweek.com/?article=gwtc-5-0-constraints-on-the-cosmic-expansion-rate-and-modified-gravitational-wave-propagation&lang=en",
    "shareUrl": "https://www.cosmosweek.com/noticia/gwtc-5-0-constraints-on-the-cosmic-expansion-rate-and-modified-gravitational-wave-propagation/",
    "shareUrl_pt": "https://www.cosmosweek.com/noticia/gwtc-5-0-constraints-on-the-cosmic-expansion-rate-and-modified-gravitational-wave-propagation/",
    "shareUrl_en": "https://www.cosmosweek.com/en/news/gwtc-5-0-constraints-on-the-cosmic-expansion-rate-and-modified-gravitational-wave-propagation/",
    "canonicalUrl": "https://www.cosmosweek.com/noticia/gwtc-5-0-constraints-on-the-cosmic-expansion-rate-and-modified-gravitational-wave-propagation/",
    "canonicalUrl_pt": "https://www.cosmosweek.com/noticia/gwtc-5-0-constraints-on-the-cosmic-expansion-rate-and-modified-gravitational-wave-propagation/",
    "canonicalUrl_en": "https://www.cosmosweek.com/en/news/gwtc-5-0-constraints-on-the-cosmic-expansion-rate-and-modified-gravitational-wave-propagation/",
    "defaultLanguage": "pt-BR",
    "availableLanguages": [
      "pt-BR",
      "en-US"
    ...
    "imageAlt": "GWTC-5.0: Restrições na taxa de expansão cósmica e propagação de ondas gravitacionais modificadas",
    "imageAlt_pt": "GWTC-5.0: Restrições na taxa de expansão cósmica e propagação de ondas gravitacionais modificadas",
    "imageAlt_en": "GWTC-5.0: Constraints on the Cosmic Expansion Rate and Modified Gravitational-wave Propagation",
  ...
  },
  {
    ...
    "cat": "Astronomia",
    "catCls": "astronomia",
    "img": "https://www.nasa.gov/wp-content/uploads/2026/01/4-nb2-9930-a.jpg",
    "inline_images": [
      {
    ...
    "sub": "Jaclyn Kagey, líder de atividade extraveicular do programa Artemis na NASA, desempenha um papel crucial na preparação diária dos astronautas para as futuras missões lunares.",
    "sub_pt": "Jaclyn Kagey, líder de atividade extraveicular do programa Artemis na NASA, desempenha um papel crucial na preparação diária dos astronautas para as futuras missões lunares.",
    "sub_en": "For Jaclyn Kagey, preparing astronauts to put boots on the Moon is part of her daily work.",
    "excerpt": "Jaclyn Kagey, líder de atividade extraveicular do programa Artemis na NASA, desempenha um papel crucial na preparação diária dos astronautas para as futuras missões lunares.",
    "excerpt_pt": "Jaclyn Kagey, líder de atividade extraveicular do programa Artemis na NASA, desempenha um papel crucial na preparação diária dos astronautas para as futuras missões lunares.",
    ...
    "body": "<p>Jaclyn Kagey, como líder de atividade extraveicular (EVA) do programa Artemis na Diretoria de Operações de Voo da NASA, desempenha um papel fundamental na preparação dos astronautas para o retorno da humanidade à Lua. Sua rotina diária envolve garantir que as futuras tripulações estejam plenamente capacitadas e seguras para realizar as complexas operações na superfície lunar. Este empreendimento histórico, que visa estabelecer uma presença humana sustentável na Lua, depende diretamente da meticulosa preparação e do planejamento estratégico liderados por profissionais como Kagey. A missão Artemis não apenas representa um marco na exploração espacial, mas também pavimenta o caminho para futuras jornadas ao espaço profundo, com a Lua servindo como um ponto de partida crucial.</p><p>A responsabilidade de Kagey abrange a definição das atividades que serão realizadas na superfície lunar, um processo que exige estreita colaboração com cientistas e parceiros da indústria. Durante as missões Artemis, os astronautas explorarão o Polo Sul da Lua, uma região inexplorada por humanos até então, que oferece oportunidades únicas para descobertas científicas e tecnológicas. A equipe de Kagey trabalha para antecipar todos os cenários possíveis, desde a coleta de amostras geológicas até a instalação de equipamentos científicos, garantindo que cada passo na Lua seja executado com precisão e segurança. Essa fase de planejamento é vital para o sucesso das operações e para maximizar o potencial científico de cada missão.</p><p>Parte essencial dessa preparação ocorre no Laboratório de Flutuabilidade Neutra (NBL) da NASA, onde astronautas e controladores de voo ensaiam procedimentos de caminhada espacial em um ambiente que simula a microgravidade. No NBL, os participantes praticam tarefas complexas sob a água, replicando as condições e os desafios que enfrentarão no espaço e na superfície lunar. Essa imersão permite que a equipe identifique e resolva potenciais problemas operacionais antes que as missões sejam lançadas, aprimorando a coordenação e a execução das atividades extraveiculares. A simulação rigorosa é um pilar da segurança e eficácia das futuras explorações lunares.</p><p>A vasta experiência de Jaclyn Kagey na NASA, que se estende por mais de 25 anos, é um trunfo inestimável para o programa Artemis. Ao longo de sua carreira, ela esteve envolvida em alguns dos programas mais complexos da agência, acumulando um conhecimento profundo sobre operações espaciais e gerenciamento de missões. Sua trajetória profissional demonstra uma capacidade comprovada de liderar equipes em ambientes de alta pressão e de desenvolver soluções inovadoras para desafios técnicos e operacionais. Essa bagagem é crucial para moldar o retorno da humanidade à Lua, garantindo que as lições aprendidas em missões anteriores sejam aplicadas para otimizar as futuras explorações.</p><p>Trabalhando no Centro de Controle da Missão, Kagey e sua equipe demonstram diariamente a capacidade de operar sob pressão, como evidenciado durante as simulações de caminhada espacial no Johnson Space Center em Houston. Esses exercícios não apenas testam os procedimentos e equipamentos, mas também a resiliência e a coordenação da equipe. Há momentos em que a missão exige dedicação total, e a liderança de Kagey é fundamental para inspirar e guiar os envolvidos. A preparação minuciosa e a capacidade de resposta rápida são essenciais para o sucesso das missões Artemis, que representam um dos maiores desafios da exploração espacial contemporânea.</p><p>Em suma, o trabalho de Jaclyn Kagey é indispensável para o sucesso do programa Artemis, que visa não apenas levar humanos de volta à Lua, mas também estabelecer as bases para a exploração de Marte e além. Sua dedicação em preparar astronautas para os rigores do ambiente lunar, desde o treinamento em simulações de microgravidade até a definição detalhada das atividades na superfície, reflete o compromisso da NASA com a segurança e a inovação. Ao moldar cada aspecto das operações extraveiculares, Kagey está, de fato, moldando o futuro da exploração espacial humana.</p>",
    "body_pt": "<p>Jaclyn Kagey, como líder de atividade extraveicular (EVA) do programa Artemis na Diretoria de Operações de Voo da NASA, desempenha um papel fundamental na preparação dos astronautas para o retorno da humanidade à Lua. Sua rotina diária envolve garantir que as futuras tripulações estejam plenamente capacitadas e seguras para realizar as complexas operações na superfície lunar. Este empreendimento histórico, que visa estabelecer uma presença humana sustentável na Lua, depende diretamente da meticulosa preparação e do planejamento estratégico liderados por profissionais como Kagey. A missão Artemis não apenas representa um marco na exploração espacial, mas também pavimenta o caminho para futuras jornadas ao espaço profundo, com a Lua servindo como um ponto de partida crucial.</p><p>A responsabilidade de Kagey abrange a definição das atividades que serão realizadas na superfície lunar, um processo que exige estreita colaboração com cientistas e parceiros da indústria. Durante as missões Artemis, os astronautas explorarão o Polo Sul da Lua, uma região inexplorada por humanos até então, que oferece oportunidades únicas para descobertas científicas e tecnológicas. A equipe de Kagey trabalha para antecipar todos os cenários possíveis, desde a coleta de amostras geológicas até a instalação de equipamentos científicos, garantindo que cada passo na Lua seja executado com precisão e segurança. Essa fase de planejamento é vital para o sucesso das operações e para maximizar o potencial científico de cada missão.</p><p>Parte essencial dessa preparação ocorre no Laboratório de Flutuabilidade Neutra (NBL) da NASA, onde astronautas e controladores de voo ensaiam procedimentos de caminhada espacial em um ambiente que simula a microgravidade. No NBL, os participantes praticam tarefas complexas sob a água, replicando as condições e os desafios que enfrentarão no espaço e na superfície lunar. Essa imersão permite que a equipe identifique e resolva potenciais problemas operacionais antes que as missões sejam lançadas, aprimorando a coordenação e a execução das atividades extraveiculares. A simulação rigorosa é um pilar da segurança e eficácia das futuras explorações lunares.</p><p>A vasta experiência de Jaclyn Kagey na NASA, que se estende por mais de 25 anos, é um trunfo inestimável para o programa Artemis. Ao longo de sua carreira, ela esteve envolvida em alguns dos programas mais complexos da agência, acumulando um conhecimento profundo sobre operações espaciais e gerenciamento de missões. Sua trajetória profissional demonstra uma capacidade comprovada de liderar equipes em ambientes de alta pressão e de desenvolver soluções inovadoras para desafios técnicos e operacionais. Essa bagagem é crucial para moldar o retorno da humanidade à Lua, garantindo que as lições aprendidas em missões anteriores sejam aplicadas para otimizar as futuras explorações.</p><p>Trabalhando no Centro de Controle da Missão, Kagey e sua equipe demonstram diariamente a capacidade de operar sob pressão, como evidenciado durante as simulações de caminhada espacial no Johnson Space Center em Houston. Esses exercícios não apenas testam os procedimentos e equipamentos, mas também a resiliência e a coordenação da equipe. Há momentos em que a missão exige dedicação total, e a liderança de Kagey é fundamental para inspirar e guiar os envolvidos. A preparação minuciosa e a capacidade de resposta rápida são essenciais para o sucesso das missões Artemis, que representam um dos maiores desafios da exploração espacial contemporânea.</p><p>Em suma, o trabalho de Jaclyn Kagey é indispensável para o sucesso do programa Artemis, que visa não apenas levar humanos de volta à Lua, mas também estabelecer as bases para a exploração de Marte e além. Sua dedicação em preparar astronautas para os rigores do ambiente lunar, desde o treinamento em simulações de microgravidade até a definição detalhada das atividades na superfície, reflete o compromisso da NASA com a segurança e a inovação. Ao moldar cada aspecto das operações extraveiculares, Kagey está, de fato, moldando o futuro da exploração espacial humana.</p>",
    ...
    "highlights": [
      "Ponto central: Jaclyn Kagey, líder de atividade extraveicular do programa Artemis na NASA, desempenha um papel crucial na preparação diária dos astronautas para as.",
      "Dado-chave: Jaclyn Kagey, líder de atividade extraveicular do programa Artemis na NASA, desempenha um papel crucial na preparação diária dos astronautas.",
    ...
    "highlights_en": [
      "Core point: For Jaclyn Kagey, preparing astronauts to put boots on the Moon is part of her daily work.",
      "Key detail: For Jaclyn Kagey, preparing astronauts to put boots on the Moon is part of her daily work",
    ...
    "lastModifiedIso": "2026-05-26T18:28:43+00:00",
    "source": "NASA News Releases",
    ...
    "realUrl": "https://www.cosmosweek.com/?article=jaclyn-kagey-shapes-humanity-s-return-to-the-moon",
    "realUrl_pt": "https://www.cosmosweek.com/?article=jaclyn-kagey-shapes-humanity-s-return-to-the-moon",
    "realUrl_en": "https://www.cosmosweek.com/?article=jaclyn-kagey-shapes-humanity-s-return-to-the-moon&lang=en",
    "shareUrl": "https://www.cosmosweek.com/noticia/jaclyn-kagey-shapes-humanity-s-return-to-the-moon/",
    "shareUrl_pt": "https://www.cosmosweek.com/noticia/jaclyn-kagey-shapes-humanity-s-return-to-the-moon/",
    "shareUrl_en": "https://www.cosmosweek.com/en/news/jaclyn-kagey-shapes-humanity-s-return-to-the-moon/",
    "canonicalUrl": "https://www.cosmosweek.com/noticia/jaclyn-kagey-shapes-humanity-s-return-to-the-moon/",
    "canonicalUrl_pt": "https://www.cosmosweek.com/noticia/jaclyn-kagey-shapes-humanity-s-return-to-the-moon/",
    "canonicalUrl_en": "https://www.cosmosweek.com/en/news/jaclyn-kagey-shapes-humanity-s-return-to-the-moon/",
    "defaultLanguage": "pt-BR",
    "availableLanguages": [
      "pt-BR",
      "en-US"
    ...
    "imageAlt": "Jaclyn Kagey molda o retorno da humanidade à Lua",
    "imageAlt_pt": "Jaclyn Kagey molda o retorno da humanidade à Lua",
    "imageAlt_en": "Jaclyn Kagey Shapes Humanity’s Return to the Moon",
    "coverageKind": "agency",
    "coverageKindLabel": "Fonte institucional",
    "coverageKindLabel_pt": "Fonte institucional",
    "coverageKindLabel_en": "Institutional source",
  ...
  },
  {
    ...
    "video": null,
    "audio": null,
    "title": "Chamada para Criativos: NASA Busca Parceiros para Contar Histórias de Missões",
    "title_pt": "Chamada para Criativos: NASA Busca Parceiros para Contar Histórias de Missões",
    "title_en": "Call for Creatives: NASA Seeks Help Illuminating Mission Storytelling",
    "sub": "A NASA, em sua contínua busca por inovação e exploração em benefício da humanidade, está convidando criadores de diversas áreas a se tornarem parceiros na divulgação das histórias.",
    "sub_pt": "A NASA, em sua contínua busca por inovação e exploração em benefício da humanidade, está convidando criadores de diversas áreas a se tornarem parceiros na divulgação das histórias.",
    ...
    "excerpt": "A NASA, em sua contínua busca por inovação e exploração em benefício da humanidade, está convidando criadores de diversas áreas a se tornarem parceiros na divulgação das histórias de suas missões, que abrangem desde o Programa Artemis até avanços em propulsão.",
    "excerpt_pt": "A NASA, em sua contínua busca por inovação e exploração em benefício da humanidade, está convidando criadores de diversas áreas a se tornarem parceiros na divulgação das histórias de suas missões, que abrangem desde o Programa Artemis até avanços em propulsão.",
    "excerpt_en": "As NASA pushes the boundaries of exploration and innovation for the benefit of humanity, the agency is looking for partners to share mission stories covering Artemis Moon missions, nuclear propulsion, aeronautics, and more.",
    "body": "<p>A Agência Espacial Americana (NASA), em sua incessante busca por expandir os limites da exploração e da inovação para o benefício da humanidade, está ativamente procurando parceiros estratégicos para compartilhar as narrativas envolventes de suas diversas missões. Essas histórias abrangem desde o ambicioso Programa Artemis, focado no retorno à Lua, até os avanços revolucionários em propulsão nuclear e as inovações na área da aeronáutica, entre muitas outras iniciativas cruciais. A agência reconhece o poder da narrativa para inspirar e educar o público global sobre o impacto de suas descobertas e tecnologias.</p><p>Para concretizar essa iniciativa, a NASA publicou um Anúncio de Propostas em 21 de maio, convidando formalmente uma ampla gama de profissionais criativos. Cineastas, documentaristas, compositores, contadores de histórias, poetas e outros artistas são encorajados a submeter suas propostas de parceria com a agência. O objetivo é estabelecer colaborações que possam traduzir a complexidade e a emoção das missões espaciais em formatos acessíveis e cativantes para diferentes públicos, ampliando o alcance e a compreensão do trabalho da NASA.</p><p>Os interessados têm até terça-feira, 30 de junho, para enviar suas propostas. Nesta rodada inicial, a NASA pretende selecionar até dez parceiros para firmar Acordos da Lei Espacial sem financiamento. Esses acordos visam facilitar a colaboração e o acesso a informações e recursos da agência, permitindo que os parceiros desenvolvam conteúdos autênticos e informativos. A expectativa é que essas parcerias revelem os bastidores e ofereçam insights valiosos sobre as múltiplas missões da NASA, destacando a engenhosidade e a dedicação por trás de cada empreendimento.</p><p>As áreas de foco para esta oportunidade incluem, mas não se limitam a, o Programa Artemis, que visa estabelecer uma presença humana sustentável na Lua e preparar o caminho para futuras missões a Marte. Outro ponto de interesse é o avanço da propulsão nuclear da NASA, com destaque para a missão Space Reactor-1 Freedom, planejada para 2028, que transportará a carga útil Skyfall a Marte, representando um salto tecnológico significativo. Além disso, o trabalho de aviação de ponta da NASA, por meio de testes de voo e outros esforços de pesquisa e desenvolvimento, também é uma área prioritária para a criação de conteúdo.</p><p>Embora esta oportunidade esteja primariamente focada em criadores sediados nos Estados Unidos, a agência considerará propostas que incluam uma participação minoritária de colaboradores internacionais. As propostas devem ser detalhadas, especificando a área de foco desejada, os arranjos propostos para financiamento e distribuição do conteúdo, e quaisquer necessidades específicas que os parceiros possam ter da NASA para avançar em seus projetos. Isso pode incluir, por exemplo, acesso a instalações da agência, a especialistas técnicos ou a pessoal envolvido nas missões.</p><p>A colaboração com a comunidade criativa é vista pela NASA como um meio essencial para democratizar o conhecimento científico e tecnológico, tornando-o mais acessível e inspirador para um público global. Ao permitir que diferentes vozes e perspectivas contem as histórias de suas missões, a agência espera não apenas informar, mas também engajar e motivar a próxima geração de cientistas, engenheiros e exploradores. Essas parcerias são fundamentais para manter o público conectado com os desafios e os triunfos da exploração espacial.</p><p>A iniciativa reforça o compromisso da NASA com a transparência e a educação pública, reconhecendo que a exploração espacial é um esforço coletivo que transcende fronteiras e disciplinas. Ao convidar criadores a se juntarem a essa jornada, a agência busca construir uma ponte entre a ciência de ponta e a expressão artística, garantindo que as conquistas e os desafios da exploração espacial sejam compreendidos e celebrados por todos. Este é um convite para que a criatividade humana se una à curiosidade científica na busca por desvendar os mistérios do universo.</p>",
    "body_pt": "<p>A Agência Espacial Americana (NASA), em sua incessante busca por expandir os limites da exploração e da inovação para o benefício da humanidade, está ativamente procurando parceiros estratégicos para compartilhar as narrativas envolventes de suas diversas missões. Essas histórias abrangem desde o ambicioso Programa Artemis, focado no retorno à Lua, até os avanços revolucionários em propulsão nuclear e as inovações na área da aeronáutica, entre muitas outras iniciativas cruciais. A agência reconhece o poder da narrativa para inspirar e educar o público global sobre o impacto de suas descobertas e tecnologias.</p><p>Para concretizar essa iniciativa, a NASA publicou um Anúncio de Propostas em 21 de maio, convidando formalmente uma ampla gama de profissionais criativos. Cineastas, documentaristas, compositores, contadores de histórias, poetas e outros artistas são encorajados a submeter suas propostas de parceria com a agência. O objetivo é estabelecer colaborações que possam traduzir a complexidade e a emoção das missões espaciais em formatos acessíveis e cativantes para diferentes públicos, ampliando o alcance e a compreensão do trabalho da NASA.</p><p>Os interessados têm até terça-feira, 30 de junho, para enviar suas propostas. Nesta rodada inicial, a NASA pretende selecionar até dez parceiros para firmar Acordos da Lei Espacial sem financiamento. Esses acordos visam facilitar a colaboração e o acesso a informações e recursos da agência, permitindo que os parceiros desenvolvam conteúdos autênticos e informativos. A expectativa é que essas parcerias revelem os bastidores e ofereçam insights valiosos sobre as múltiplas missões da NASA, destacando a engenhosidade e a dedicação por trás de cada empreendimento.</p><p>As áreas de foco para esta oportunidade incluem, mas não se limitam a, o Programa Artemis, que visa estabelecer uma presença humana sustentável na Lua e preparar o caminho para futuras missões a Marte. Outro ponto de interesse é o avanço da propulsão nuclear da NASA, com destaque para a missão Space Reactor-1 Freedom, planejada para 2028, que transportará a carga útil Skyfall a Marte, representando um salto tecnológico significativo. Além disso, o trabalho de aviação de ponta da NASA, por meio de testes de voo e outros esforços de pesquisa e desenvolvimento, também é uma área prioritária para a criação de conteúdo.</p><p>Embora esta oportunidade esteja primariamente focada em criadores sediados nos Estados Unidos, a agência considerará propostas que incluam uma participação minoritária de colaboradores internacionais. As propostas devem ser detalhadas, especificando a área de foco desejada, os arranjos propostos para financiamento e distribuição do conteúdo, e quaisquer necessidades específicas que os parceiros possam ter da NASA para avançar em seus projetos. Isso pode incluir, por exemplo, acesso a instalações da agência, a especialistas técnicos ou a pessoal envolvido nas missões.</p><p>A colaboração com a comunidade criativa é vista pela NASA como um meio essencial para democratizar o conhecimento científico e tecnológico, tornando-o mais acessível e inspirador para um público global. Ao permitir que diferentes vozes e perspectivas contem as histórias de suas missões, a agência espera não apenas informar, mas também engajar e motivar a próxima geração de cientistas, engenheiros e exploradores. Essas parcerias são fundamentais para manter o público conectado com os desafios e os triunfos da exploração espacial.</p><p>A iniciativa reforça o compromisso da NASA com a transparência e a educação pública, reconhecendo que a exploração espacial é um esforço coletivo que transcende fronteiras e disciplinas. Ao convidar criadores a se juntarem a essa jornada, a agência busca construir uma ponte entre a ciência de ponta e a expressão artística, garantindo que as conquistas e os desafios da exploração espacial sejam compreendidos e celebrados por todos. Este é um convite para que a criatividade humana se una à curiosidade científica na busca por desvendar os mistérios do universo.</p>",
    "body_en": "<p>As NASA pushes the boundaries of exploration and innovation for the benefit of humanity, the agency is looking for partners to share mission stories covering Artemis Moon missions, nuclear propulsion, aeronautics, and more. The institutional report frames the development in practical terms and ties it to the broader mission or observing effort.</p><p>That matters because astronomy does not advance on single detections. The field builds confidence by accumulating independent observations across different wavelengths, instruments and epochs until isolated signals become defensible conclusions. What looks convincing in one dataset can dissolve when a second instrument looks at the same target, and what looks marginal can solidify when follow-up campaigns confirm the original reading. The current standard requires that a result survive this triangulation before the community treats it as settled. NASA published an Announcement for Proposals on May 21 asking filmmakers, documentarians, songwriters, storytellers, poets, and others to submit proposals to partner. NASA As NASA pushes the boundaries of exploration and innovation for the benefit of humanity, the agency is looking for partners to share mission stories covering Artemis Moon.</p><p>NASA published an Announcement for Proposals on May 21 asking filmmakers, documentarians, songwriters, storytellers, poets, and others to submit proposals to partner with the. In this initial round, NASA is seeking up to 10 partners for unfunded Space Act Agreements to share the stories behind, and insights into, multiple NASA missions, including, but.</p><p>Learn more about Artemis on the agency’s website. NASA’s advancement of nuclear propulsion, including the Space Reactor-1 Freedom mission to Mars in 2028 carrying the Skyfall payload.</p><p>NASA’s cutting-edge aviation work through flight tests and other efforts. Creators, the agency will consider proposals with a minority of international participants.</p><p>What gives the story weight is not just the object itself, but the way the measurement trims the range of plausible physical explanations. Astronomy has accumulated enough cases to know that the most interesting results are rarely the ones that confirm expectations cleanly; they are the ones that confirm some expectations while complicating others, or that open a parameter space that previous instruments could not reach. The scientific community evaluates these contributions by asking whether the new data constrain a model in a way that older data could not, and whether those constraints survive systematic review.</p><p>Proposals should detail which area of focus is desired, funding and distribution arrangements, and any specifics needs from NASA to move forward (access to facilities, personnel.</p><p>Because the account originates with NASA News Releases, it functions best as a primary institutional report that is close to the data and operations, not as independent scientific validation. Institutional communications are produced by organizations with legitimate interests in presenting their work in a favorable light, which does not make them unreliable but does make them partial. Details that complicate the narrative, including instrument limitations, unexpected failures and results below projections, tend to be minimized relative to progress messages. Technical documentation and peer-reviewed publications, where they exist, provide the complementary layer that institutional releases cannot substitute.</p><p>The next step is to see whether other instruments and other wavelengths tell the same story. Campaigns with JWST, the VLT, the forthcoming Extremely Large Telescopes and radio arrays will provide the spectral coverage and spatial resolution needed to move from detection to physical characterization. The timeline for that kind of confirmation is typically measured in years, not months, which is worth keeping in mind when reading the current result.</p><p class=\"art-source\"><a href=\"https://www.nasa.gov/news-release/call-for-creatives-nasa-seeks-help-illuminating-mission-storytelling/\" target=\"_blank\" rel=\"noopener noreferrer\">Source</a></p>",
    "highlights": [
      "Ponto central: A NASA, em sua contínua busca por inovação e exploração em benefício da humanidade, está convidando criadores de diversas áreas a se tornarem.",
      "Dado-chave: A NASA, em sua contínua busca por inovação e exploração em benefício da humanidade, está convidando criadores de diversas áreas a se tornarem",
      "Origem institucional: distinguir anúncio de evidência."
    ],
    "highlights_pt": [
      "Ponto central: A NASA, em sua contínua busca por inovação e exploração em benefício da humanidade, está convidando criadores de diversas áreas a se tornarem.",
    ...
    "lastModifiedIso": "2026-05-23T16:38:38+00:00",
    "source": "NASA News Releases",
    "sourceDomain": "www. nasa. gov",
    "sourceType": "agency",
    "sourceTypeLabel": "Fonte institucional",
    ...
    "realUrl": "https://www.cosmosweek.com/?article=call-for-creatives-nasa-seeks-help-illuminating-mission-storytelling",
    "realUrl_pt": "https://www.cosmosweek.com/?article=call-for-creatives-nasa-seeks-help-illuminating-mission-storytelling",
    "realUrl_en": "https://www.cosmosweek.com/?article=call-for-creatives-nasa-seeks-help-illuminating-mission-storytelling&lang=en",
    "shareUrl": "https://www.cosmosweek.com/noticia/call-for-creatives-nasa-seeks-help-illuminating-mission-storytelling/",
    "shareUrl_pt": "https://www.cosmosweek.com/noticia/call-for-creatives-nasa-seeks-help-illuminating-mission-storytelling/",
    "shareUrl_en": "https://www.cosmosweek.com/en/news/call-for-creatives-nasa-seeks-help-illuminating-mission-storytelling/",
    "canonicalUrl": "https://www.cosmosweek.com/noticia/call-for-creatives-nasa-seeks-help-illuminating-mission-storytelling/",
    "canonicalUrl_pt": "https://www.cosmosweek.com/noticia/call-for-creatives-nasa-seeks-help-illuminating-mission-storytelling/",
    "canonicalUrl_en": "https://www.cosmosweek.com/en/news/call-for-creatives-nasa-seeks-help-illuminating-mission-storytelling/",
    "defaultLanguage": "pt-BR",
    "availableLanguages": [
      "pt-BR",
      "en-US"
    ...
    "imageAlt": "Chamada para Criativos: NASA Busca Parceiros para Contar Histórias de Missões",
    "imageAlt_pt": "Chamada para Criativos: NASA Busca Parceiros para Contar Histórias de Missões",
    "imageAlt_en": "Call for Creatives: NASA Seeks Help Illuminating Mission Storytelling",
    "coverageKind": "agency",
    "coverageKindLabel": "Fonte institucional",
    "coverageKindLabel_pt": "Fonte institucional",
    "coverageKindLabel_en": "Institutional source",
