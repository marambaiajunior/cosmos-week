...
window.postsData = [
  ...
  },
  {
    ...
    "cat": "Astronomia",
    "catCls": "astronomia",
    "img": "https://www.nasa.gov/wp-content/uploads/2026/05/nasa-spacex-crs-34-mission-overview.png",
    "inline_images": [],
    "video": null,
    "audio": null,
    ...
    "sub": "A NASA e a SpaceX têm como meta um lançamento em meados de maio para entregar investigações científicas, suprimentos e equipamentos à Estação Espacial Internacional.",
    "sub_pt": "A NASA e a SpaceX têm como meta um lançamento em meados de maio para entregar investigações científicas, suprimentos e equipamentos à Estação Espacial Internacional.",
    "sub_en": "NASA and SpaceX are targeting a mid-May launch to deliver scientific investigations, supplies, and equipment to the International Space Station.",
    "excerpt": "A NASA e a SpaceX têm como meta um lançamento em meados de maio para entregar investigações científicas, suprimentos e equipamentos à Estação Espacial Internacional.",
    "excerpt_pt": "A NASA e a SpaceX têm como meta um lançamento em meados de maio para entregar investigações científicas, suprimentos e equipamentos à Estação Espacial Internacional.",
    "excerpt_en": "NASA and SpaceX are targeting a mid-May launch to deliver scientific investigations, supplies, and equipment to the International Space Station.",
    "body": "<p>A NASA e a SpaceX planejam o lançamento da 34ª missão comercial de reabastecimento em meados de maio. Esta missão utilizará a espaçonave Dragon da SpaceX, impulsionada pelo foguete Falcon 9, para transportar investigações científicas, suprimentos e equipamentos essenciais à Estação Espacial Internacional (EEI). O lançamento está programado para ocorrer do Complexo de Lançamento 40, localizado na Estação da Força Espacial de Cabo Canaveral, na Flórida. A carga total a ser entregue pela espaçonave Dragon é de aproximadamente 6.500 libras, reforçando o compromisso contínuo com a pesquisa e manutenção da EEI.</p><p>Por mais de 25 anos, a Estação Espacial Internacional tem sido uma plataforma crucial para a pesquisa em microgravidade, oferecendo capacidades de investigação que foram utilizadas por cientistas de mais de 110 países. Durante esse período, foram realizadas mais de 4.000 experiências, contribuindo significativamente para o avanço do conhecimento em diversas áreas científicas. A continuidade dessas operações é vital para a exploração espacial e para o desenvolvimento de tecnologias e compreensões que beneficiam a vida na Terra.</p><p>A bordo da espaçonave Dragon, além dos suprimentos para a tripulação, seguirão diversos novos experimentos científicos. Um deles é o projeto ODYSSEY, que tem como objetivo avaliar a eficácia dos simuladores de microgravidade baseados na Terra. Este estudo é fundamental para determinar quão bem esses simuladores conseguem recriar as condições encontradas no espaço, o que pode otimizar o treinamento de astronautas e o desenvolvimento de futuras pesquisas sem a necessidade de ir ao espaço.</p><p>Outro experimento notável é o Green Bone, que se dedicará à observação do crescimento e desenvolvimento de células ósseas em um ambiente de microgravidade. A particularidade deste estudo reside na utilização de uma estrutura óssea feita de madeira, proporcionando um substrato inovador para a análise. Compreender como as células ósseas reagem e se adaptam ao espaço é crucial para a saúde dos astronautas em missões de longa duração e para o desenvolvimento de tratamentos para doenças ósseas na Terra.</p><p>A chegada da espaçonave de carga SpaceX Dragon à Estação Espacial Internacional será cuidadosamente monitorada por uma equipe internacional. O astronauta da NASA Jack Hathaway e a astronauta da ESA (Agência Espacial Europeia) Sophie Adenot serão os responsáveis por acompanhar e supervisionar as operações de acoplagem e descarregamento. A coordenação entre as agências espaciais é um exemplo da colaboração global que sustenta as operações da EEI e garante o sucesso de cada missão de reabastecimento.</p>",
    "body_pt": "<p>A NASA e a SpaceX planejam o lançamento da 34ª missão comercial de reabastecimento em meados de maio. Esta missão utilizará a espaçonave Dragon da SpaceX, impulsionada pelo foguete Falcon 9, para transportar investigações científicas, suprimentos e equipamentos essenciais à Estação Espacial Internacional (EEI). O lançamento está programado para ocorrer do Complexo de Lançamento 40, localizado na Estação da Força Espacial de Cabo Canaveral, na Flórida. A carga total a ser entregue pela espaçonave Dragon é de aproximadamente 6.500 libras, reforçando o compromisso contínuo com a pesquisa e manutenção da EEI.</p><p>Por mais de 25 anos, a Estação Espacial Internacional tem sido uma plataforma crucial para a pesquisa em microgravidade, oferecendo capacidades de investigação que foram utilizadas por cientistas de mais de 110 países. Durante esse período, foram realizadas mais de 4.000 experiências, contribuindo significativamente para o avanço do conhecimento em diversas áreas científicas. A continuidade dessas operações é vital para a exploração espacial e para o desenvolvimento de tecnologias e compreensões que beneficiam a vida na Terra.</p><p>A bordo da espaçonave Dragon, além dos suprimentos para a tripulação, seguirão diversos novos experimentos científicos. Um deles é o projeto ODYSSEY, que tem como objetivo avaliar a eficácia dos simuladores de microgravidade baseados na Terra. Este estudo é fundamental para determinar quão bem esses simuladores conseguem recriar as condições encontradas no espaço, o que pode otimizar o treinamento de astronautas e o desenvolvimento de futuras pesquisas sem a necessidade de ir ao espaço.</p><p>Outro experimento notável é o Green Bone, que se dedicará à observação do crescimento e desenvolvimento de células ósseas em um ambiente de microgravidade. A particularidade deste estudo reside na utilização de uma estrutura óssea feita de madeira, proporcionando um substrato inovador para a análise. Compreender como as células ósseas reagem e se adaptam ao espaço é crucial para a saúde dos astronautas em missões de longa duração e para o desenvolvimento de tratamentos para doenças ósseas na Terra.</p><p>A chegada da espaçonave de carga SpaceX Dragon à Estação Espacial Internacional será cuidadosamente monitorada por uma equipe internacional. O astronauta da NASA Jack Hathaway e a astronauta da ESA (Agência Espacial Europeia) Sophie Adenot serão os responsáveis por acompanhar e supervisionar as operações de acoplagem e descarregamento. A coordenação entre as agências espaciais é um exemplo da colaboração global que sustenta as operações da EEI e garante o sucesso de cada missão de reabastecimento.</p>",
    "body_en": "<p>NASA and SpaceX are targeting a mid-May launch to deliver scientific investigations, supplies, and equipment to the International Space Station. The institutional report frames the development in practical terms and ties it to the broader mission or observing effort.</p><p>It matters because astronomy does not advance on single detections. The field builds confidence by accumulating independent observations across different wavelengths, instruments and epochs until isolated signals become defensible conclusions. What looks convincing in one dataset can dissolve when a second instrument looks at the same target, and what looks marginal can solidify when follow-up campaigns confirm the original reading. The current standard requires that a result survive this triangulation before the community treats it as settled. NASA’s SpaceX 34th commercial resupply mission will launch on the company’s Dragon spacecraft on the SpaceX Falcon 9 rocket to deliver research and supplies to the International. NASA’s SpaceX 34th commercial resupply mission will launch from Launch Complex 40 at Cape Canaveral Space Force Station in Florida.</p><p>NASA For more than 25 years, the International Space Station has provided research capabilities used by scientists from more than 110 countries to conduct more than 4, 000. In addition to cargo for the crew aboard the space station, Dragon will deliver several new science experiments, including: ODYSSEY will evaluate how well Earth-based microgravity.</p><p>NASA Green Bone will observe how bone cells grow and develop in space on a bone scaffold made from wood. NASA astronaut Jack Hathaway and ESA (European Space Agency) astronaut Sophie Adenot will monitor the arrival of the SpaceX Dragon cargo spacecraft from the International Space.</p><p>NASA and SpaceX are targeting a mid-May launch to deliver scientific investigations, supplies, and equipment to the International Space Article NASA’s SpaceX 34th commercial. NASA NASA and SpaceX are targeting a mid-May launch to deliver scientific investigations, supplies, and equipment to the International Space Station.</p><p>What gives the story weight is not just the object itself, but the way the measurement trims the range of plausible physical explanations. Astronomy has accumulated enough cases to know that the most interesting results are rarely the ones that confirm expectations cleanly; they are the ones that confirm some expectations while complicating others, or that open a parameter space that previous instruments could not reach. The scientific community evaluates these contributions by asking whether the new data constrain a model in a way that older data could not, and whether those constraints survive systematic review.</p><p>Loaded with about 6, 500 pounds of supplies, the SpaceX Dragon spacecraft will lift off aboard the company’s Falcon 9 rocket from Launch Complex 40 at Cape Canaveral Space Force. For more than 25 years, the International Space Station has provided research capabilities used by scientists from more than 110 countries to conduct more than 4, 000 experiments.</p><p>Because the account originates with NASA News Releases, it functions best as a primary institutional report that is close to the data and operations, not as independent scientific validation. Institutional communications are produced by organizations with legitimate interests in presenting their work in a favorable light, which does not make them unreliable but does make them partial. Details that complicate the narrative, including instrument limitations, unexpected failures and results below projections, tend to be minimized relative to progress messages. Technical documentation and peer-reviewed publications, where they exist, provide the complementary layer that institutional releases cannot substitute.</p><p>The next step is to see whether other instruments and other wavelengths tell the same story. Campaigns with JWST, the VLT, the forthcoming Extremely Large Telescopes and radio arrays will provide the spectral coverage and spatial resolution needed to move from detection to physical characterization. The timeline for that kind of confirmation is typically measured in years, not months, which is worth keeping in mind when reading the current result.</p><p class=\"art-source\"><a href=\"https://www.nasa.gov/general/nasas-spacex-34th-commercial-resupply-mission-overview/\" target=\"_blank\" rel=\"noopener noreferrer\">Source</a></p>",
    "highlights": [
      "Em foco: A NASA e a SpaceX têm como meta um lançamento em meados de maio para entregar investigações científicas, suprimentos e equipamentos à Estação",
    ...
    "lastModifiedIso": "2026-05-09T16:42:39+00:00",
    ...
    "realUrl": "https://www.cosmosweek.com/?article=nasa-s-spacex-34th-commercial-resupply-mission-overview",
    "realUrl_pt": "https://www.cosmosweek.com/?article=nasa-s-spacex-34th-commercial-resupply-mission-overview",
    "realUrl_en": "https://www.cosmosweek.com/?article=nasa-s-spacex-34th-commercial-resupply-mission-overview&lang=en",
    "shareUrl": "https://www.cosmosweek.com/noticia/nasa-s-spacex-34th-commercial-resupply-mission-overview/",
    "shareUrl_pt": "https://www.cosmosweek.com/noticia/nasa-s-spacex-34th-commercial-resupply-mission-overview/",
    "shareUrl_en": "https://www.cosmosweek.com/en/news/nasa-s-spacex-34th-commercial-resupply-mission-overview/",
    "canonicalUrl": "https://www.cosmosweek.com/noticia/nasa-s-spacex-34th-commercial-resupply-mission-overview/",
    "canonicalUrl_pt": "https://www.cosmosweek.com/noticia/nasa-s-spacex-34th-commercial-resupply-mission-overview/",
    "canonicalUrl_en": "https://www.cosmosweek.com/en/news/nasa-s-spacex-34th-commercial-resupply-mission-overview/",
    "defaultLanguage": "pt-BR",
    "availableLanguages": [
      "pt-BR",
      "en-US"
    ...
    "imageAlt": "Visão geral da 34ª missão de reabastecimento comercial da SpaceX da NASA",
    "imageAlt_pt": "Visão geral da 34ª missão de reabastecimento comercial da SpaceX da NASA",
    "imageAlt_en": "NASA’s SpaceX 34th Commercial Resupply Mission Overview",
    "coverageKind": "agency",
  ...
  },
  {
    ...
    "cat": "Biologia",
    "catCls": "biologia",
    "img": "https://www.nasa.gov/wp-content/uploads/2026/05/grc-2026-c-00617.jpg",
    "inline_images": [],
    "video": null,
    "audio": null,
    ...
    "sub": "A NASA está realizando testes cruciais com um sistema regenerativo de células de combustível, uma tecnologia promissora para o armazenamento de energia em futuras missões lunares.",
    "sub_pt": "A NASA está realizando testes cruciais com um sistema regenerativo de células de combustível, uma tecnologia promissora para o armazenamento de energia em futuras missões lunares.",
    ...
    "highlights_en": [
      ...
      "Key detail: With a small blue crane, four researchers hoist a cylindrical fuel cell, which looks like a stack of flattened silver and gold soda cans bundled.",
    ...
    "realUrl": "https://www.cosmosweek.com/?article=nasa-fuel-cell-tests-pave-way-for-energy-storage-on-moon",
    "realUrl_pt": "https://www.cosmosweek.com/?article=nasa-fuel-cell-tests-pave-way-for-energy-storage-on-moon",
    "realUrl_en": "https://www.cosmosweek.com/?article=nasa-fuel-cell-tests-pave-way-for-energy-storage-on-moon&lang=en",
    "shareUrl": "https://www.cosmosweek.com/noticia/nasa-fuel-cell-tests-pave-way-for-energy-storage-on-moon/",
    "shareUrl_pt": "https://www.cosmosweek.com/noticia/nasa-fuel-cell-tests-pave-way-for-energy-storage-on-moon/",
    "shareUrl_en": "https://www.cosmosweek.com/en/news/nasa-fuel-cell-tests-pave-way-for-energy-storage-on-moon/",
    "canonicalUrl": "https://www.cosmosweek.com/noticia/nasa-fuel-cell-tests-pave-way-for-energy-storage-on-moon/",
    "canonicalUrl_pt": "https://www.cosmosweek.com/noticia/nasa-fuel-cell-tests-pave-way-for-energy-storage-on-moon/",
    "canonicalUrl_en": "https://www.cosmosweek.com/en/news/nasa-fuel-cell-tests-pave-way-for-energy-storage-on-moon/",
    "defaultLanguage": "pt-BR",
    "availableLanguages": [
      "pt-BR",
      "en-US"
    ...
    "imageAlt": "Testes de células de combustível da NASA abrem caminho para armazenamento de energia na Lua",
    "imageAlt_pt": "Testes de células de combustível da NASA abrem caminho para armazenamento de energia na Lua",
    "imageAlt_en": "NASA Fuel Cell Tests Pave Way for Energy Storage on Moon",
    "coverageKind": "agency",
    "coverageKindLabel": "Fonte institucional",
    "coverageKindLabel_pt": "Fonte institucional",
    "coverageKindLabel_en": "Institutional source",
  ...
  },
  {
    ...
    "catCls": "terra",
    "img": "https://www.nasa.gov/wp-content/uploads/2026/05/1-pia26648-superrotor2-crop.jpg",
    "inline_images": [
      {
    ...
    "audio": null,
    "title": "NASA testa pás de rotor de helicóptero de próxima geração para Marte, superando Mach 1",
    "title_pt": "NASA testa pás de rotor de helicóptero de próxima geração para Marte, superando Mach 1",
    "title_en": "NASA Pushes Next-Gen Mars Helicopter Rotor Blades Past Mach 1",
    "sub": "As pás de rotor projetadas para os helicópteros de próxima geração da NASA, que explorarão novas altitudes em Marte, superaram a barreira do som durante testes realizados em março.",
    "sub_pt": "As pás de rotor projetadas para os helicópteros de próxima geração da NASA, que explorarão novas altitudes em Marte, superaram a barreira do som durante testes realizados em março.",
    ...
    "realUrl": "https://www.cosmosweek.com/?article=nasa-pushes-next-gen-mars-helicopter-rotor-blades-past-mach-1",
    "realUrl_pt": "https://www.cosmosweek.com/?article=nasa-pushes-next-gen-mars-helicopter-rotor-blades-past-mach-1",
    "realUrl_en": "https://www.cosmosweek.com/?article=nasa-pushes-next-gen-mars-helicopter-rotor-blades-past-mach-1&lang=en",
    "shareUrl": "https://www.cosmosweek.com/noticia/nasa-pushes-next-gen-mars-helicopter-rotor-blades-past-mach-1/",
    "shareUrl_pt": "https://www.cosmosweek.com/noticia/nasa-pushes-next-gen-mars-helicopter-rotor-blades-past-mach-1/",
    "shareUrl_en": "https://www.cosmosweek.com/en/news/nasa-pushes-next-gen-mars-helicopter-rotor-blades-past-mach-1/",
    "canonicalUrl": "https://www.cosmosweek.com/noticia/nasa-pushes-next-gen-mars-helicopter-rotor-blades-past-mach-1/",
    "canonicalUrl_pt": "https://www.cosmosweek.com/noticia/nasa-pushes-next-gen-mars-helicopter-rotor-blades-past-mach-1/",
    "canonicalUrl_en": "https://www.cosmosweek.com/en/news/nasa-pushes-next-gen-mars-helicopter-rotor-blades-past-mach-1/",
    "defaultLanguage": "pt-BR",
    "availableLanguages": [
      "pt-BR",
      "en-US"
    ...
    "imageAlt": "NASA testa pás de rotor de helicóptero de próxima geração para Marte, superando Mach 1",
    "imageAlt_pt": "NASA testa pás de rotor de helicóptero de próxima geração para Marte, superando Mach 1",
    "imageAlt_en": "NASA Pushes Next-Gen Mars Helicopter Rotor Blades Past Mach 1",
    "coverageKind": "agency",
    "coverageKindLabel": "Fonte institucional",
    "coverageKindLabel_pt": "Fonte institucional",
    "coverageKindLabel_en": "Institutional source",
  ...
  },
  {
    ...
    "highlights": [
      "Ponto central: Uma pequena nave espacial, desenvolvida por uma universidade com o apoio da NASA, foi lançada para iniciar o estudo de neutrinos, partículas que.",
      "Dado-chave: Uma pequena nave espacial, desenvolvida por uma universidade com o apoio da NASA, foi lançada para iniciar o estudo de neutrinos, partículas que.",
      "Origem institucional: distinguir anúncio de evidência."
    ],
    "highlights_pt": [
      "Ponto central: Uma pequena nave espacial, desenvolvida por uma universidade com o apoio da NASA, foi lançada para iniciar o estudo de neutrinos, partículas que.",
    ...
    "highlights_en": [
      ...
      "Key detail: Through NASA, a university-designed small spacecraft is paving the way to studying particles, known as neutrinos, that move through the universe.",
      "Institutional origin: separate announcement from evidence."
    ],
    "date": "07 mai 2026",
    "date_pt": "07 mai 2026",
  ...
  {
    "id": 7,
    "slug": "revisiting-the-constancy-of-the-speed-of-light-galaxy-cluster-mass-bias-implications",
    "cat": "Cosmologia",
    "catCls": "cosmologia",
    ...
    "video": null,
    "audio": null,
    "title": "Revisitando a Constância da Velocidade da Luz: Implicações do Viés de Massa em Aglomerados de Galáxias",
    "title_pt": "Revisitando a Constância da Velocidade da Luz: Implicações do Viés de Massa em Aglomerados de Galáxias",
    "title_en": "Revisiting the Constancy of the Speed of Light: Galaxy Cluster Mass Bias Implications",
    "sub": "Avanços recentes nas observações de aglomerados de galáxias têm possibilitado a realização de diversos testes de física fundamental.",
    "sub_pt": "Avanços recentes nas observações de aglomerados de galáxias têm possibilitado a realização de diversos testes de física fundamental.",
    "sub_en": "In recent years, improvements in galaxy cluster observations have enabled a variety of tests of fundamental physics using these systems.",
    "excerpt": "Avanços recentes nas observações de aglomerados de galáxias têm possibilitado a realização de diversos testes de física fundamental.",
    "excerpt_pt": "Avanços recentes nas observações de aglomerados de galáxias têm possibilitado a realização de diversos testes de física fundamental.",
    "excerpt_en": "In recent years, improvements in galaxy cluster observations have enabled a variety of tests of fundamental physics using these systems.",
    "body": "<p>Nos últimos anos, as significativas melhorias nas observações de aglomerados de galáxias têm proporcionado uma plataforma robusta para a realização de diversos testes de física fundamental. Estes sistemas cósmicos, que representam as maiores estruturas gravitacionalmente ligadas no universo, oferecem um laboratório natural para investigar propriedades fundamentais do cosmos. Neste contexto, o presente trabalho se dedica a testar a constância da velocidade da luz, $c$, um dos pilares da física moderna, utilizando uma abordagem que combina diferentes conjuntos de dados cosmológicos. A precisão crescente das medições astrofísicas permite agora sondar com maior rigor os princípios subjacentes à nossa compreensão do universo, incluindo a invariância de constantes físicas ao longo do tempo e do espaço.</p><p>Para atingir este objetivo, combinamos medições da fração de massa de gás de raios X provenientes de aglomerados de galáxias com medições de distância de luminosidade de supernovas do tipo Ia (SNe Ia) obtidas do catálogo Pantheon+. A integração desses dois tipos de observações é crucial, pois cada um fornece informações complementares sobre a expansão do universo e a distribuição de massa em grandes escalas. As SNe Ia, conhecidas como &#x27;velas padrão&#x27;, são essenciais para determinar distâncias cosmológicas com alta precisão, enquanto os aglomerados de galáxias, com seu gás quente emissor de raios X, permitem inferir a distribuição de massa bariônica e total. Essa combinação de dados permite uma análise multifacetada que fortalece a robustez das conclusões.</p><p>Adotamos os valores prévios de SH0ES para a constante de Hubble ($H_0$) e a razão de densidade de bárions para matéria total ($\\Omega_b/\\Omega_m$) derivados de observações de agrupamento de galáxias. Essa escolha estratégica minimiza a dependência de nossa análise em qualquer modelo cosmológico específico, o que é fundamental para garantir a generalidade e a aplicabilidade dos nossos resultados. A minimização da dependência de modelos cosmológicos específicos é um aspecto crítico para evitar vieses e para que as conclusões sobre a constância da velocidade da luz sejam o mais independentes possível de suposições cosmológicas. Além disso, exploramos diferentes suposições para a calibração da massa dos aglomerados, também conhecida como viés de massa, que é uma fonte significativa de incerteza em estudos cosmológicos baseados em aglomerados. Essas suposições incluem estimativas baseadas nos projetos \\textsc{CLASH}, \\textsc{CCCP} e nos dados do satélite Planck.</p><p>Ao adotar as calibrações de massa baseadas nos projetos \\textsc{CLASH} ​​e \\textsc{CCCP}, não encontramos nenhum desvio significativo da hipótese de uma velocidade da luz constante. Estes resultados são consistentes com o modelo padrão da cosmologia, que postula que a velocidade da luz no vácuo é uma constante universal e invariável. A concordância com essas duas abordagens de calibração reforça a robustez de nossas medições e a validade da premissa de uma velocidade da luz constante sob essas condições. A ausência de desvios notáveis sugere que, dentro das incertezas observacionais e das suposições de calibração desses projetos, não há evidências que desafiem a constância de $c$ em escalas cosmológicas.</p><p>No entanto, a calibração de massa baseada nos dados do satélite Planck produziu uma tensão moderada em relação à hipótese de uma velocidade da luz constante. Sob esta suposição, a constância de $c$ mostrou-se apenas marginalmente consistente no nível de $2\\sigma$. Essa discrepância é um achado notável, pois o Planck é conhecido por suas medições de alta precisão da radiação cósmica de fundo em micro-ondas, que fornecem restrições cosmológicas rigorosas. A tensão observada com a calibração de Planck pode indicar a presença de efeitos sistemáticos ainda não totalmente compreendidos, seja nas medições de aglomerados de galáxias, na calibração de massa do Planck, ou em uma possível necessidade de revisão de aspectos do modelo cosmológico padrão. É crucial investigar as origens dessa tensão para determinar se ela aponta para nova física ou para a necessidade de refinar as metodologias de calibração.</p><p>A divergência entre os resultados obtidos com diferentes calibrações de massa sublinha a importância de uma compreensão aprofundada dos vieses de massa em aglomerados de galáxias para testes de física fundamental. Embora as calibrações \\textsc{CLASH} ​​e \\textsc{CCCP} apoiem a constância da velocidade da luz, a tensão com a calibração de Planck exige investigação adicional. Futuros estudos devem focar na redução das incertezas sistemáticas associadas à calibração de massa dos aglomerados e na exploração de modelos alternativos que possam explicar a discrepância observada. A resolução desta tensão será fundamental para consolidar nossa compreensão da velocidade da luz e suas implicações para a cosmologia e a física de partículas.</p>",
    "body_pt": "<p>Nos últimos anos, as significativas melhorias nas observações de aglomerados de galáxias têm proporcionado uma plataforma robusta para a realização de diversos testes de física fundamental. Estes sistemas cósmicos, que representam as maiores estruturas gravitacionalmente ligadas no universo, oferecem um laboratório natural para investigar propriedades fundamentais do cosmos. Neste contexto, o presente trabalho se dedica a testar a constância da velocidade da luz, $c$, um dos pilares da física moderna, utilizando uma abordagem que combina diferentes conjuntos de dados cosmológicos. A precisão crescente das medições astrofísicas permite agora sondar com maior rigor os princípios subjacentes à nossa compreensão do universo, incluindo a invariância de constantes físicas ao longo do tempo e do espaço.</p><p>Para atingir este objetivo, combinamos medições da fração de massa de gás de raios X provenientes de aglomerados de galáxias com medições de distância de luminosidade de supernovas do tipo Ia (SNe Ia) obtidas do catálogo Pantheon+. A integração desses dois tipos de observações é crucial, pois cada um fornece informações complementares sobre a expansão do universo e a distribuição de massa em grandes escalas. As SNe Ia, conhecidas como &#x27;velas padrão&#x27;, são essenciais para determinar distâncias cosmológicas com alta precisão, enquanto os aglomerados de galáxias, com seu gás quente emissor de raios X, permitem inferir a distribuição de massa bariônica e total. Essa combinação de dados permite uma análise multifacetada que fortalece a robustez das conclusões.</p><p>Adotamos os valores prévios de SH0ES para a constante de Hubble ($H_0$) e a razão de densidade de bárions para matéria total ($\\Omega_b/\\Omega_m$) derivados de observações de agrupamento de galáxias. Essa escolha estratégica minimiza a dependência de nossa análise em qualquer modelo cosmológico específico, o que é fundamental para garantir a generalidade e a aplicabilidade dos nossos resultados. A minimização da dependência de modelos cosmológicos específicos é um aspecto crítico para evitar vieses e para que as conclusões sobre a constância da velocidade da luz sejam o mais independentes possível de suposições cosmológicas. Além disso, exploramos diferentes suposições para a calibração da massa dos aglomerados, também conhecida como viés de massa, que é uma fonte significativa de incerteza em estudos cosmológicos baseados em aglomerados. Essas suposições incluem estimativas baseadas nos projetos \\textsc{CLASH}, \\textsc{CCCP} e nos dados do satélite Planck.</p><p>Ao adotar as calibrações de massa baseadas nos projetos \\textsc{CLASH} ​​e \\textsc{CCCP}, não encontramos nenhum desvio significativo da hipótese de uma velocidade da luz constante. Estes resultados são consistentes com o modelo padrão da cosmologia, que postula que a velocidade da luz no vácuo é uma constante universal e invariável. A concordância com essas duas abordagens de calibração reforça a robustez de nossas medições e a validade da premissa de uma velocidade da luz constante sob essas condições. A ausência de desvios notáveis sugere que, dentro das incertezas observacionais e das suposições de calibração desses projetos, não há evidências que desafiem a constância de $c$ em escalas cosmológicas.</p><p>No entanto, a calibração de massa baseada nos dados do satélite Planck produziu uma tensão moderada em relação à hipótese de uma velocidade da luz constante. Sob esta suposição, a constância de $c$ mostrou-se apenas marginalmente consistente no nível de $2\\sigma$. Essa discrepância é um achado notável, pois o Planck é conhecido por suas medições de alta precisão da radiação cósmica de fundo em micro-ondas, que fornecem restrições cosmológicas rigorosas. A tensão observada com a calibração de Planck pode indicar a presença de efeitos sistemáticos ainda não totalmente compreendidos, seja nas medições de aglomerados de galáxias, na calibração de massa do Planck, ou em uma possível necessidade de revisão de aspectos do modelo cosmológico padrão. É crucial investigar as origens dessa tensão para determinar se ela aponta para nova física ou para a necessidade de refinar as metodologias de calibração.</p><p>A divergência entre os resultados obtidos com diferentes calibrações de massa sublinha a importância de uma compreensão aprofundada dos vieses de massa em aglomerados de galáxias para testes de física fundamental. Embora as calibrações \\textsc{CLASH} ​​e \\textsc{CCCP} apoiem a constância da velocidade da luz, a tensão com a calibração de Planck exige investigação adicional. Futuros estudos devem focar na redução das incertezas sistemáticas associadas à calibração de massa dos aglomerados e na exploração de modelos alternativos que possam explicar a discrepância observada. A resolução desta tensão será fundamental para consolidar nossa compreensão da velocidade da luz e suas implicações para a cosmologia e a física de partículas.</p>",
    "body_en": "<p>In recent years, improvements in galaxy cluster observations have enabled a variety of tests of fundamental physics using these systems. The new analysis still awaits peer review, but it already lays out the central claim clearly.</p><p>It matters because cosmology operates at the edge of what current instruments can measure, where systematic errors and model assumptions are never trivial. Small discrepancies between independent measurements have historically pointed toward missing physics rather than simple calibration errors, and the ongoing tension in the Hubble constant is a live example of how a persistent disagreement between methods can reshape the theoretical landscape. Each new dataset that approaches this territory with independent systematics adds real information to a problem that has resisted easy resolution for more than a decade. We adopt the SH0ES prior on $H_0$ and the $Ω_b/Ω_m$ ratio from galaxy clustering observations, thereby minimizing the dependence of our analysis on any specific cosmological model. We find no deviation from a constant $c$ when adopting \\textsc{CLASH} or \\textsc{CCCP} priors, while Planck-based calibration yields a mild tension, with the hypothesis of.</p><p>Both individuals and organizations that work with arXivLabs have embraced and accepted our values of openness, community, excellence, and user data privacy. ArXiv is committed to these values and only works with partners that adhere to them.</p><p>Have an idea for a project that will add value for arXiv&#x27;s community. In this work, we test the constancy of the speed of light, $c$, by combining X-ray gas mass fraction measurements from galaxy clusters with SNe Ia luminosity distance measurements.</p><p>We adopt the SH0ES prior on $H_0$ and the $\\Omega_b/\\Omega_m$ ratio from galaxy clustering observations, thereby minimizing the dependence of our analysis on any specific. We explore different assumptions for the cluster mass calibration (mass bias), including \\textsc{CLASH}, \\textsc{CCCP}, and Planck-based estimates.</p><p>The relevance goes beyond one dataset because even small shifts in measured parameters can matter when the field is testing the limits of the standard cosmological model. The Lambda-CDM framework describes the observable universe with remarkable economy, but its success rests on two components, dark matter and dark energy, whose physical nature remains entirely unknown. Any credible measurement that tightens or loosens the constraints on those components moves the entire theoretical enterprise forward, regardless of whether the immediate result looks dramatic on its own terms.</p><p>Because this is still a preprint, the result should be read with genuine interest and proportionate caution. Peer review is not a guarantee of correctness, but it is a process that forces authors to respond to technical criticism from specialists who have no stake in a particular outcome. Preprints that survive that process, often with substantive revisions, emerge with a stronger evidential base than the version that first appeared. Until that stage is complete, the responsible reading keeps uncertainty explicitly visible rather than treating the claims as established findings.</p><p>The next step is to see whether the effect survives when independent surveys, different calibration strategies and tighter control of systematic uncertainties enter the picture. Programmes such as Euclid, DESI and the Rubin Observatory will deliver datasets over the next several years that cover the same parameter space with largely independent methods. If the current signal persists through those tests, its theoretical implications will become impossible to set aside. Until peer review and independent follow-up address those open questions, skepticism is not a failure of appreciation for the work; it is part of how science decides what to keep.</p><p class=\"art-source\"><a href=\"https://arxiv.org/abs/2605.06267v1\" target=\"_blank\" rel=\"noopener noreferrer\">Source</a></p>",
    "highlights": [
      "Ponto central: Avanços recentes nas observações de aglomerados de galáxias têm possibilitado a realização de diversos testes de física fundamental.",
      "Dado-chave: Avanços recentes nas observações de aglomerados de galáxias têm possibilitado a realização de diversos testes de física fundamental",
    ...
    "highlights_en": [
      "Core point: In recent years, improvements in galaxy cluster observations have enabled a variety of tests of fundamental physics using these systems.",
      "Key detail: In recent years, improvements in galaxy cluster observations have enabled a variety of tests of fundamental physics using these systems",
    ...
    "read_pt": "4 min de leitura",
    "read_en": "4 min read",
    "publishedIso": "2026-05-07T13:43:27+00:00",
    "lastModifiedIso": "2026-05-08T17:02:51+00:00",
    ...
    "keywords": [
      ...
      "arXiv Cosmology",
      "Cosmos Week",
      "Revisitando a constância da velocidade da luz",
      "implicações do viés de massa do aglomerado de galáxias"
    ],
    "keywords_pt": [
      "Cosmologia",
      "arXiv Cosmology",
    ...
    "keywords_en": [
      ...
      "arXiv Cosmology",
      "Cosmos Week",
      "Revisiting the constancy of the speed of light",
      "implications of galaxy cluster mass bias"
    ],
    "srcUrl": "https://arxiv.org/abs/2605.06267v1",
    "realUrl": "https://www.cosmosweek.com/?article=revisiting-the-constancy-of-the-speed-of-light-galaxy-cluster-mass-bias-implications",
    "realUrl_pt": "https://www.cosmosweek.com/?article=revisiting-the-constancy-of-the-speed-of-light-galaxy-cluster-mass-bias-implications",
    "realUrl_en": "https://www.cosmosweek.com/?article=revisiting-the-constancy-of-the-speed-of-light-galaxy-cluster-mass-bias-implications&lang=en",
    "shareUrl": "https://www.cosmosweek.com/noticia/revisiting-the-constancy-of-the-speed-of-light-galaxy-cluster-mass-bias-implications/",
    "shareUrl_pt": "https://www.cosmosweek.com/noticia/revisiting-the-constancy-of-the-speed-of-light-galaxy-cluster-mass-bias-implications/",
    "shareUrl_en": "https://www.cosmosweek.com/en/news/revisiting-the-constancy-of-the-speed-of-light-galaxy-cluster-mass-bias-implications/",
    "canonicalUrl": "https://www.cosmosweek.com/noticia/revisiting-the-constancy-of-the-speed-of-light-galaxy-cluster-mass-bias-implications/",
    "canonicalUrl_pt": "https://www.cosmosweek.com/noticia/revisiting-the-constancy-of-the-speed-of-light-galaxy-cluster-mass-bias-implications/",
    "canonicalUrl_en": "https://www.cosmosweek.com/en/news/revisiting-the-constancy-of-the-speed-of-light-galaxy-cluster-mass-bias-implications/",
    "defaultLanguage": "pt-BR",
    "availableLanguages": [
      "pt-BR",
      "en-US"
    ...
    "imageAlt": "Revisitando a Constância da Velocidade da Luz: Implicações do Viés de Massa em Aglomerados de Galáxias",
    "imageAlt_pt": "Revisitando a Constância da Velocidade da Luz: Implicações do Viés de Massa em Aglomerados de Galáxias",
    "imageAlt_en": "Revisiting the Constancy of the Speed of Light: Galaxy Cluster Mass Bias Implications",
  ...
  {
    "id": 8,
    "slug": "a-comparative-study-of-occurrence-rates-and-nature-of-ultraluminous-x-ray-sources-in-spiral-and-",
    "cat": "Astrofísica",
    "catCls": "astrofisica",
    ...
    "video": null,
    "audio": null,
    "title": "Um estudo comparativo das taxas de ocorrência e natureza de fontes de raios X ultraluminosos em galáxias espirais e elípticas",
    "title_pt": "Um estudo comparativo das taxas de ocorrência e natureza de fontes de raios X ultraluminosos em galáxias espirais e elípticas",
    "title_en": "A comparative study of occurrence rates and nature of Ultraluminous X-ray sources in spiral and elliptical galaxies",
    "sub": "Fontes de raios X ultraluminosas são principalmente fontes pontuais extragalácticas não nucleares com luminosidade de raios X excedendo a luminosidade de Eddington do buraco negro.",
    "sub_pt": "Fontes de raios X ultraluminosas são principalmente fontes pontuais extragalácticas não nucleares com luminosidade de raios X excedendo a luminosidade de Eddington do buraco negro.",
    "sub_en": "Ultraluminous X-ray sources are mostly extragalactic non-nuclear point sources having X-ray luminosity exceeding the Eddington luminosity of 10 $M_\\odot$ black hole i.",
    "excerpt": "Fontes de raios X ultraluminosas são principalmente fontes pontuais extragalácticas não nucleares com luminosidade de raios X excedendo a luminosidade de Eddington do buraco negro.",
    "excerpt_pt": "Fontes de raios X ultraluminosas são principalmente fontes pontuais extragalácticas não nucleares com luminosidade de raios X excedendo a luminosidade de Eddington do buraco negro.",
    "excerpt_en": "Ultraluminous X-ray sources are mostly extragalactic non-nuclear point sources having X-ray luminosity exceeding the Eddington luminosity of 10 $M_\\odot$ black hole i.",
    "body": "<p>Fontes de raios X ultraluminosas (ULXs) são objetos astronômicos extragalácticos não nucleares, caracterizados por serem fontes pontuais com uma luminosidade de raios X ($L_X$) que excede o limite de Eddington para um buraco negro estelar de 10 massas solares ($M_\\odot$), ou seja, $L_X \\geq 10^{39}$ erg s$^{-1}$. Esses objetos são observados em diversos tipos de galáxias, incluindo espirais, elípticas e anãs irregulares. A natureza exata dos ULXs ainda é objeto de debate, mas eles são geralmente considerados buracos negros de massa estelar com acreção super-Eddington ou buracos negros de massa intermediária. A compreensão de suas propriedades e distribuição é crucial para avançar no conhecimento sobre a evolução de buracos negros e galáxias.</p><p>A taxa de ocorrência de ULXs varia significativamente entre as galáxias; algumas podem hospedar apenas uma única ULX, enquanto outras abrigam um grande número. Essa variabilidade sugere que as propriedades dos ULXs podem diferir dependendo do ambiente galáctico e da frequência de sua ocorrência. Neste trabalho, o objetivo principal foi identificar possíveis distinções nas características dos ULXs entre duas categorias extremas de galáxias: as espirais e as elípticas. O foco foi direcionado para ULXs que ocorrem a uma taxa de um por galáxia (denominado grupo $N=1$) e aqueles que se manifestam em taxas mais elevadas. Essa abordagem comparativa visa desvendar se a população de ULXs é homogênea ou se apresenta subpopulações distintas em diferentes contextos galácticos.</p><p>Para realizar esta investigação, foi adotado um esquema metodológico rigoroso e eficaz, projetado para gerar amostras confiáveis e com fluxo limitado. Essas amostras foram cuidadosamente selecionadas para corresponder aos dois grupos de interesse — galáxias espirais e elípticas — e para as duas categorias de ocorrência de ULXs (N=1 e N&gt;1). A seleção criteriosa das amostras é fundamental para garantir que as comparações subsequentes sejam estatisticamente válidas e que as inferências sobre as propriedades dos ULXs sejam robustas. A metodologia empregada permitiu uma análise detalhada das características espectrais e de luminosidade dos ULXs em cada grupo, fornecendo a base para as conclusões apresentadas.</p><p>A partir da análise dos dados, inferiu-se a presença de uma população distinta de ULXs no grupo de galáxias espirais com $N=1$. Esta população se destaca por conter uma fração considerável de fontes com espectros de raios X &quot;leves&quot; (soft) e &quot;duros&quot; (hard), indicando uma diversidade em suas propriedades de emissão. Em contraste, as demais categorias de ULXs, tanto em espirais com $N&gt;1$ quanto em elípticas, contêm predominantemente fontes com espectros mais &quot;duros&quot;. Essa diferença sugere que o ambiente galáctico e a densidade de ULXs podem influenciar as características físicas desses objetos, possivelmente refletindo diferentes mecanismos de acreção ou estágios evolutivos.</p><p>Adicionalmente, o estudo revelou a existência de seis ULXs em galáxias elípticas do grupo $N=1$ que estão associados a aglomerados globulares. Essa associação é um achado significativo, pois aglomerados globulares são ambientes propícios para a formação de buracos negros estelares e sistemas binários de raios X. A identificação desses ULXs em aglomerados globulares pode fornecer pistas importantes sobre a formação e evolução de buracos negros em ambientes de alta densidade estelar. Além disso, foram identificados alguns candidatos luminosos que, com base em suas características, provavelmente abrigam objetos compactos de massa considerável, possivelmente buracos negros de massa intermediária ou buracos negros estelares com acreção super-Eddington extrema.</p><p>Os resultados obtidos neste estudo reforçam a complexidade da população de ULXs e a necessidade de abordagens comparativas para desvendar suas múltiplas facetas. A distinção entre as populações de ULXs em galáxias espirais e elípticas, bem como a correlação com a taxa de ocorrência e a associação com aglomerados globulares, abrem novas avenidas para futuras investigações. Compreender as condições que levam à formação e sustentação de ULXs com diferentes propriedades espectrais e em distintos ambientes galácticos é fundamental para aprimorar nossos modelos de evolução estelar e de buracos negros no universo.</p>",
    "body_pt": "<p>Fontes de raios X ultraluminosas (ULXs) são objetos astronômicos extragalácticos não nucleares, caracterizados por serem fontes pontuais com uma luminosidade de raios X ($L_X$) que excede o limite de Eddington para um buraco negro estelar de 10 massas solares ($M_\\odot$), ou seja, $L_X \\geq 10^{39}$ erg s$^{-1}$. Esses objetos são observados em diversos tipos de galáxias, incluindo espirais, elípticas e anãs irregulares. A natureza exata dos ULXs ainda é objeto de debate, mas eles são geralmente considerados buracos negros de massa estelar com acreção super-Eddington ou buracos negros de massa intermediária. A compreensão de suas propriedades e distribuição é crucial para avançar no conhecimento sobre a evolução de buracos negros e galáxias.</p><p>A taxa de ocorrência de ULXs varia significativamente entre as galáxias; algumas podem hospedar apenas uma única ULX, enquanto outras abrigam um grande número. Essa variabilidade sugere que as propriedades dos ULXs podem diferir dependendo do ambiente galáctico e da frequência de sua ocorrência. Neste trabalho, o objetivo principal foi identificar possíveis distinções nas características dos ULXs entre duas categorias extremas de galáxias: as espirais e as elípticas. O foco foi direcionado para ULXs que ocorrem a uma taxa de um por galáxia (denominado grupo $N=1$) e aqueles que se manifestam em taxas mais elevadas. Essa abordagem comparativa visa desvendar se a população de ULXs é homogênea ou se apresenta subpopulações distintas em diferentes contextos galácticos.</p><p>Para realizar esta investigação, foi adotado um esquema metodológico rigoroso e eficaz, projetado para gerar amostras confiáveis e com fluxo limitado. Essas amostras foram cuidadosamente selecionadas para corresponder aos dois grupos de interesse — galáxias espirais e elípticas — e para as duas categorias de ocorrência de ULXs (N=1 e N&gt;1). A seleção criteriosa das amostras é fundamental para garantir que as comparações subsequentes sejam estatisticamente válidas e que as inferências sobre as propriedades dos ULXs sejam robustas. A metodologia empregada permitiu uma análise detalhada das características espectrais e de luminosidade dos ULXs em cada grupo, fornecendo a base para as conclusões apresentadas.</p><p>A partir da análise dos dados, inferiu-se a presença de uma população distinta de ULXs no grupo de galáxias espirais com $N=1$. Esta população se destaca por conter uma fração considerável de fontes com espectros de raios X &quot;leves&quot; (soft) e &quot;duros&quot; (hard), indicando uma diversidade em suas propriedades de emissão. Em contraste, as demais categorias de ULXs, tanto em espirais com $N&gt;1$ quanto em elípticas, contêm predominantemente fontes com espectros mais &quot;duros&quot;. Essa diferença sugere que o ambiente galáctico e a densidade de ULXs podem influenciar as características físicas desses objetos, possivelmente refletindo diferentes mecanismos de acreção ou estágios evolutivos.</p><p>Adicionalmente, o estudo revelou a existência de seis ULXs em galáxias elípticas do grupo $N=1$ que estão associados a aglomerados globulares. Essa associação é um achado significativo, pois aglomerados globulares são ambientes propícios para a formação de buracos negros estelares e sistemas binários de raios X. A identificação desses ULXs em aglomerados globulares pode fornecer pistas importantes sobre a formação e evolução de buracos negros em ambientes de alta densidade estelar. Além disso, foram identificados alguns candidatos luminosos que, com base em suas características, provavelmente abrigam objetos compactos de massa considerável, possivelmente buracos negros de massa intermediária ou buracos negros estelares com acreção super-Eddington extrema.</p><p>Os resultados obtidos neste estudo reforçam a complexidade da população de ULXs e a necessidade de abordagens comparativas para desvendar suas múltiplas facetas. A distinção entre as populações de ULXs em galáxias espirais e elípticas, bem como a correlação com a taxa de ocorrência e a associação com aglomerados globulares, abrem novas avenidas para futuras investigações. Compreender as condições que levam à formação e sustentação de ULXs com diferentes propriedades espectrais e em distintos ambientes galácticos é fundamental para aprimorar nossos modelos de evolução estelar e de buracos negros no universo.</p>",
    "body_en": "<p>Ultraluminous X-ray sources are mostly extragalactic non-nuclear point sources having X-ray luminosity exceeding the Eddington luminosity of 10 $M_\\odot$ black hole i. e, $L_X \\geq $ 10$^{39}$ erg ~s$^{-1}$. The new analysis still awaits peer review, but it already lays out the central claim clearly.</p><p>That matters because astrophysics becomes persuasive only when an observed signal can be tied to a physically defensible explanation. Compact objects such as neutron stars and black holes are natural laboratories for extreme physics, but the distance and complexity of these systems make interpretation difficult without multi-wavelength coverage and careful modeling. A detection without a mechanism is only half a result. the other half comes from showing that the signal fits quantitatively inside a coherent physical picture rather than merely being consistent with a broad family of models. Spirals, ellipticals and dwarf irregulars. But the rate of occurrence of ULXs per galaxy varies, some might host a single ULX, whereas some host a large number.</p><p>ULXs occurring at a rate of one per galaxy ($N=1$) and those occurring at larger rate. We adopt an effective scheme to generate flux limited, credible samples corresponding to the two groups in spirals and ellipticals.</p><p>From this study, we infer the presence of a separate population of ULXs in the $N=1$ spiral group which contains a reasonable fraction of both soft and hard sources, while the. We also find six ULXs in $N=1$ ellipticals with globular cluster association.</p><p>In addition, we identify few luminous candidates likely hosting massive accretors. This study provides crucial hints of a potential link between ULX types and their occurrence rates and host morphology, a finding that warrants validation via targeted.</p><p>The broader interest lies in turning an observational clue into something that can be weighed against competing models of the underlying physics. Astrophysics does not have the luxury of controlled experiments; everything is inferred from radiation that traveled across cosmic distances under conditions that cannot be reproduced in a terrestrial laboratory. This makes the interpretation chain longer and more uncertain than in bench science, but it also means that a well-constrained measurement of an extreme object carries theoretical information that no earthbound experiment can provide.</p><p>Both individuals and organizations that work with arXivLabs have embraced and accepted our values of openness, community, excellence, and user data privacy. ArXiv is committed to these values and only works with partners that adhere to them.</p><p>Because this is still a preprint, the result should be read with genuine interest and proportionate caution. Peer review is not a guarantee of correctness, but it is a process that forces authors to respond to technical criticism from specialists who have no stake in a particular outcome. Preprints that survive that process, often with substantive revisions, emerge with a stronger evidential base than the version that first appeared. Until that stage is complete, the responsible reading keeps uncertainty explicitly visible rather than treating the claims as established findings.</p><p>The next step is to see whether independent datasets and physical modeling converge on the same interpretation. Multi-wavelength follow-up, combining X-ray, radio and optical data where possible, is typically what separates a compelling detection from a robust physical characterization. In high-energy astrophysics, results that initially looked definitive have been revised when data from a second messenger arrived; the current result should be read with that history in mind. Until peer review and independent follow-up address those open questions, skepticism is not a failure of appreciation for the work; it is part of how science decides what to keep.</p><p class=\"art-source\"><a href=\"https://arxiv.org/abs/2605.06133v1\" target=\"_blank\" rel=\"noopener noreferrer\">Source</a></p>",
    "highlights": [
      "Ponto central: Fontes de raios X ultraluminosas são principalmente fontes pontuais extragalácticas não nucleares com luminosidade de raios X excedendo a.",
      "Dado-chave: Fontes de raios X ultraluminosas são principalmente fontes pontuais extragalácticas não nucleares com luminosidade de raios X excedendo a",
      "Resultado ainda sem revisão por pares."
    ],
    "highlights_pt": [
      "Ponto central: Fontes de raios X ultraluminosas são principalmente fontes pontuais extragalácticas não nucleares com luminosidade de raios X excedendo a.",
    ...
    "highlights_en": [
      "Core point: Ultraluminous X-ray sources are mostly extragalactic non-nuclear point sources having X-ray luminosity exceeding the Eddington luminosity of 10.",
      "Key detail: Ultraluminous X-ray sources are mostly extragalactic non-nuclear point sources having X-ray luminosity exceeding the Eddington luminosity of 10",
      "Result not yet peer reviewed."
    ],
    "date": "07 mai 2026",
    "date_pt": "07 mai 2026",
    ...
    "read_pt": "4 min de leitura",
    "read_en": "4 min read",
    "publishedIso": "2026-05-07T12:34:00+00:00",
    "lastModifiedIso": "2026-05-08T17:02:51+00:00",
    ...
    "keywords_en": [
      ...
      "arXiv High Energy Astrophysics",
      "Cosmos Week",
      "A comparative study of the occurrence rates and nature of ultraluminous X-ray sources in spiral and elliptical galaxies"
    ],
    "srcUrl": "https://arxiv.org/abs/2605.06133v1",
    "realUrl": "https://www.cosmosweek.com/?article=a-comparative-study-of-occurrence-rates-and-nature-of-ultraluminous-x-ray-sources-in-spiral-and-",
    "realUrl_pt": "https://www.cosmosweek.com/?article=a-comparative-study-of-occurrence-rates-and-nature-of-ultraluminous-x-ray-sources-in-spiral-and-",
    "realUrl_en": "https://www.cosmosweek.com/?article=a-comparative-study-of-occurrence-rates-and-nature-of-ultraluminous-x-ray-sources-in-spiral-and-&lang=en",
    "shareUrl": "https://www.cosmosweek.com/noticia/a-comparative-study-of-occurrence-rates-and-nature-of-ultraluminous-x-ray-sources-in-spiral-and-/",
    "shareUrl_pt": "https://www.cosmosweek.com/noticia/a-comparative-study-of-occurrence-rates-and-nature-of-ultraluminous-x-ray-sources-in-spiral-and-/",
    "shareUrl_en": "https://www.cosmosweek.com/en/news/a-comparative-study-of-occurrence-rates-and-nature-of-ultraluminous-x-ray-sources-in-spiral-and-/",
    "canonicalUrl": "https://www.cosmosweek.com/noticia/a-comparative-study-of-occurrence-rates-and-nature-of-ultraluminous-x-ray-sources-in-spiral-and-/",
    "canonicalUrl_pt": "https://www.cosmosweek.com/noticia/a-comparative-study-of-occurrence-rates-and-nature-of-ultraluminous-x-ray-sources-in-spiral-and-/",
    "canonicalUrl_en": "https://www.cosmosweek.com/en/news/a-comparative-study-of-occurrence-rates-and-nature-of-ultraluminous-x-ray-sources-in-spiral-and-/",
    "defaultLanguage": "pt-BR",
    "availableLanguages": [
      "pt-BR",
      "en-US"
    ...
    "imageAlt": "Um estudo comparativo das taxas de ocorrência e natureza de fontes de raios X ultraluminosos em galáxias espirais e elípticas",
    "imageAlt_pt": "Um estudo comparativo das taxas de ocorrência e natureza de fontes de raios X ultraluminosos em galáxias espirais e elípticas",
    "imageAlt_en": "A comparative study of occurrence rates and nature of Ultraluminous X-ray sources in spiral and elliptical galaxies",
    "coverageKind": "preprint",
    "coverageKindLabel": "Preprint",
    "coverageKindLabel_pt": "Preprint",
    "coverageKindLabel_en": "Preprint",
  ...
  },
  {
    ...
    "highlights": [
      "Ponto central: No extremo norte da Lapónia finlandesa, está a desenrolar-se um novo e ambicioso capítulo na observação da Terra.",
      "Dado-chave: No extremo norte da Lapónia finlandesa, está a desenrolar-se um novo e ambicioso capítulo na observação da Terra.",
      "Origem institucional: distinguir anúncio de evidência."
    ],
    "highlights_pt": [
      "Ponto central: No extremo norte da Lapónia finlandesa, está a desenrolar-se um novo e ambicioso capítulo na observação da Terra.",
    ...
    "highlights_en": [
      "Core point: In the far northern reaches of Finnish Lapland, an ambitious new chapter in Earth observation is unfolding.",
      "Key detail: In the far northern reaches of Finnish Lapland, an ambitious new chapter in Earth observation is unfolding.",
      "Institutional origin: separate announcement from evidence."
    ],
    "date": "06 mai 2026",
    "date_pt": "06 mai 2026",
