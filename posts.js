...
window.postsData = [
  {
    ...
    "highlights_en": [
      "Focus: Quando a missão Artemis II partiu em 1º de abril para a primeira viagem tripulada ao redor da Lua em mais de meio século, um pouco da tecnologia",
  ...
  },
  {
    ...
    "highlights": [
      "Em foco: A identificação das galáxias hospedeiras de fusões binárias compactas de massa estelar abrirá uma nova janela para o estudo de suas histórias de",
    ...
    "highlights_en": [
      "Focus: Finding the host galaxies of stellar-mass compact binary mergers will open a new window for studying their formation histories and measuring key",
