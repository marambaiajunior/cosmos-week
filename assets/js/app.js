...
const FULL_ARCHIVE_FEED = '/all_posts.json';
  ...
  const UI = {
    pt: {
      ...
      latestKicker: 'Cobertura recente.',
      essentialTitle: 'Leitura essencial',
      essentialKicker: 'Seleção principal da edição atual.',
      monitorTitle: 'Em observação',
      monitorKicker: 'Sinais, missões, instrumentos e resultados mais próximo na cobertura.',
      topicShelfTitle: 'Navegação temática',
      topicShelfKicker: 'Áreas permanentes de cobertura.',
