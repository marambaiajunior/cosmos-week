...
def render_static_article_page(post: dict, lang: str = 'pt') -> str:
    ...
    if show_book_context:
        book_context_html = (
            ...
            '<p>Por que pessoas inteligentes podem ficar presas em crenças que rejeitam evidências? O livro investiga como mente, redes e identidade transformam desinformação em certezas resistentes — e por que não basta apenas refutar.</p>'
            ...
            '<a class="book-context-btn" href="/livro/vortice-maligno/checklist/" data-book-cta="article_context_checklist" data-book-guide="checklist">Checklist gratuito</a>'
            '<a class="book-context-btn" href="https://clubedeautores.com.br/livro/vortice-maligno" target="_blank" rel="noopener noreferrer" data-book-cta="article_context_clube_autores" data-book-store="clube-de-autores">Comprar no Clube de Autores</a>'
            '</div>'
            '</aside>'
        )
